...
namespace das
{
    ...
    DAS_API bool isLocalOrGlobal ( ExpressionPtr expr );
...
#pragma warning(pop)
    ...
    public:
        ...
        DAS_CC_API bool compileBuiltinModule ( const string & name, const unsigned char * const str, unsigned int str_len );//will replace last symbol to 0
