# -*- coding: utf-8 -*-
#
# Daslang documentation build configuration file, created by
...
latex_documents = [
    ('reference/index', 'daslang.tex',
     ...
     ('stdlib/index', 'daslangstdlib.tex',
     'Daslang Standard Library', _stdauthor, 'manual'),
]
...
man_pages = [
    (master_doc, 'Daslang', u'Daslang Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Daslang', u'Daslang Documentation',
     author, 'Daslang', 'Fast Embeddable Scripting Language.',
     'Miscellaneous'),
]
