...
namespace das {
namespace _anon_12727810018246099894 {
...
namespace export_constructor {

struct ExportConstructor {
    void * __rtti;
    Func DAS_COMMENT((void,ast::AstStructureAnnotation)) __finalize;
    Func DAS_COMMENT((bool,ast::AstStructureAnnotation,smart_ptr_raw<Structure>,ModuleGroup,AnnotationArgumentList const ,das::string)) apply;
    Func DAS_COMMENT((bool,ast::AstStructureAnnotation,smart_ptr_raw<Structure>,ModuleGroup,AnnotationArgumentList const ,das::string)) finish;
...
inline void _FuncbuiltinTickpushTick10769833213962245646_bb7b8d710d5ac8b2 ( Context * __context__, TArray<ast::AstStructureAnnotation *> & __Arr_rename_at_181_0, ast::AstStructureAnnotation * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_85b8dade8bfc2152 ( Context * __context__, export_constructor::ExportConstructor const  & __cl_rename_at_116_2 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x3365b772c996c245] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_bb7b8d710d5ac8b2>>();
    };
    aotLib[0x4c3032a09e9d323f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_85b8dade8bfc2152>>();
    };
    resolveTypeInfoAnnotations();
}

} // namespace _anon_12727810018246099894
AotListBase impl_aot_export_constructor(_anon_12727810018246099894::registerAotFunctions);
} // namespace das
