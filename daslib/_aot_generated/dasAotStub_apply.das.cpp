...
inline void _FuncbuiltinTickpushTick10769833213962245646_73917c36584b8a28 ( Context * __context__, TArray<ast::AstCallMacro *> & __Arr_rename_at_181_0, ast::AstCallMacro * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_dec3efe1f6c45e65 ( Context * __context__, apply::ApplyMacro const  & __cl_rename_at_116_2 );
...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_1f1a10a486be953f ( Context * __context__, TArray<smart_ptr_raw<Variable>> & __a_rename_at_1215_13 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_12907c65976ea98b ( Context * __context__, TArray<smart_ptr_raw<Expression>> & __a_rename_at_1215_15 );
...
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_9deacd1af62e7af5 ( Context * __context__, int32_t __value_rename_at_882_18 );
...
{
    {
        ...
        das_iterator<TArray<smart_ptr_raw<Variable>>> __aV_iterator(__a_rename_at_1215_13);
        smart_ptr_raw<Variable> * __aV_rename_at_1217_14;
        ...
        {
            das_delete_handle<smart_ptr_raw<Variable>>::clear(__context__,(*__aV_rename_at_1217_14));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1217_14));
    };
    builtin_array_free(das_arg<TArray<smart_ptr_raw<Variable>>>::pass(__a_rename_at_1215_13),8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
{
    {
        ...
        das_iterator<TArray<smart_ptr_raw<Expression>>> __aV_iterator(__a_rename_at_1215_15);
        smart_ptr_raw<Expression> * __aV_rename_at_1217_16;
        __need_loop_1217 = __aV_iterator.first(__context__,(__aV_rename_at_1217_16)) && __need_loop_1217;
        for ( ; __need_loop_1217 ; __need_loop_1217 = __aV_iterator.next(__context__,(__aV_rename_at_1217_16)) )
        {
            das_delete_handle<smart_ptr_raw<Expression>>::clear(__context__,(*__aV_rename_at_1217_16));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1217_16));
    };
    builtin_array_free(das_arg<TArray<smart_ptr_raw<Expression>>>::pass(__a_rename_at_1215_15),8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x176f040a3bd42319] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_73917c36584b8a28>>();
    };
    aotLib[0x9fe30f37c0b6935b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_dec3efe1f6c45e65>>();
    };
    ...
    aotLib[0x2a745626aeefe058] = +[](Context & ctx) -> SimNode* {
