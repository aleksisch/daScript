...
namespace das {
namespace _anon_1201499517613448361 {
...
inline void clone_cb8a04c305a6468d ( Context * __context__, smart_ptr_raw<TypeDecl> & __dest_rename_at_367_0, smart_ptr_raw<TypeDecl> const  __src_rename_at_367_1 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_9761ce31b72a4dea ( Context * __context__, TArray<smart_ptr_raw<TypeDecl>> & __a_rename_at_1215_2 );
inline char * _FuncastTickdescribe_cppTick8220285150532477039_1f90a5fe82c5b19c ( Context * __context__, smart_ptr_raw<TypeDecl> const  __decl_rename_at_43_4, bool __substitureRef_rename_at_43_5, bool __skipRef_rename_at_43_6, bool __skipConst_rename_at_43_7, bool __redundantConst_rename_at_43_8, bool __chooseSmartPtr_rename_at_43_9 );
inline void _FuncbuiltinTickpushTick10769833213962245646_319b6d1f73c6618 ( Context * __context__, TArray<AutoTuple<char *,int32_t>> & __Arr_rename_at_181_10, AutoTuple<char *,int32_t> & __value_rename_at_181_11 );
inline void _FuncbuiltinTickpush_cloneTick15769051505004837089_abc4184427b0600f ( Context * __context__, TArray<smart_ptr_raw<TypeDecl>> & __Arr_rename_at_361_12, smart_ptr_raw<TypeDecl> const  __value_rename_at_361_13 );
inline void log_cpp_class_method_5ab80ef883f42141 ( Context * __context__, FILE const  * const  __cpp_file_rename_at_15_14, char * const  __name_rename_at_15_15, smart_ptr_raw<TypeDecl> const  __fntype_rename_at_15_16 );
inline void log_cpp_class_method_call_b515934edb7d933e ( Context * __context__, FILE const  * const  __cpp_file_rename_at_36_29, char * const  __name_rename_at_36_30, smart_ptr_raw<TypeDecl> const  __fntype_rename_at_36_31 );
inline void log_cpp_class_adapter_f21d05160c43dfb6 ( Context * __context__, FILE const  * const  __cpp_file_rename_at_66_47, char * const  __name_rename_at_66_48, smart_ptr_raw<TypeDecl> const  __cinfo_rename_at_66_49 );
...
inline void _FuncbuiltinTickpush_cloneTick15769051505004837089_abc4184427b0600f ( Context * __context__, TArray<smart_ptr_raw<TypeDecl>> &  __Arr_rename_at_361_12, smart_ptr_raw<TypeDecl> const  __value_rename_at_361_13 )
{
    clone_cb8a04c305a6468d(__context__,__Arr_rename_at_361_12(builtin_array_push_back_zero(das_arg<TArray<smart_ptr_raw<TypeDecl>>>::pass(__Arr_rename_at_361_12),8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL))),__context__),__value_rename_at_361_13);
}
...
inline void log_cpp_class_method_5ab80ef883f42141 ( Context * __context__, FILE const  * const  __cpp_file_rename_at_15_14, char * const  __name_rename_at_15_15, smart_ptr_raw<TypeDecl> const  __fntype_rename_at_15_16 )
{
    ...
    Sequence DAS_COMMENT((int32_t)) _temp_make_local_20_63_0; _temp_make_local_20_63_0;
    ...
    __rettd_rename_at_18_18 = ((char *)(char *)(_FuncastTickdescribe_cppTick8220285150532477039_1f90a5fe82c5b19c(__context__,__cft_rename_at_16_17,false,false,false,true,true)));
    builtin_fwrite(__cpp_file_rename_at_15_14,das_string_builder_temp(__context__,SimNode_AotInterop<4>(__tinfo_0, cast<char * const >::from(__rettd_rename_at_18_18), cast<char * const >::from(((char *) " ")), cast<char * const >::from(__name_rename_at_15_15), cast<char * const >::from(((char *) " ( Context * __context__, Func __funcCall__")))),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    {
        ...
        // argI: int
        das_iterator_count DAS_COMMENT((_temp_make_local_20_63_0 = (builtin_count(0,1,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)))))) __argI_iterator(0,1);
        ...
        for ( ; __need_loop_20 ; __need_loop_20 = __argN_iterator.next(__context__,(__argN_rename_at_20_25)) && __argT_iterator.next(__context__,(__argT_rename_at_20_26)) && __argI_iterator.next(__context__,(__argI_rename_at_20_27)) )
        {
            ...
            if ( __argI_rename_at_20_27 == 0 )
            {
                ...
                __argtd_rename_at_25_28 = ((char *)(char *)(_FuncastTickdescribe_cppTick8220285150532477039_1f90a5fe82c5b19c(__context__,(*__argT_rename_at_20_26),false,false,false,true,true)));
...
inline void log_cpp_class_method_call_b515934edb7d933e ( Context * __context__, FILE const  * const  __cpp_file_rename_at_36_29, char * const  __name_rename_at_36_30, smart_ptr_raw<TypeDecl> const  __fntype_rename_at_36_31 )
{
    Sequence DAS_COMMENT((int32_t)) _temp_make_local_39_63_1; _temp_make_local_39_63_1;
    Sequence DAS_COMMENT((int32_t)) _temp_make_local_54_40_2; _temp_make_local_54_40_2;
    char * __rettd_rename_at_37_32 = ((char *)(char *)(_FuncastTickdescribe_cppTick8220285150532477039_1f90a5fe82c5b19c(__context__,__fntype_rename_at_36_31->firstType /*firstType*/,false,false,false,true,true)));
    builtin_fwrite(__cpp_file_rename_at_36_29,das_string_builder_temp(__context__,SimNode_AotInterop<3>(__tinfo_3, cast<char * const >::from(((char *) "das_invoke_function<")), cast<char * const >::from(__rettd_rename_at_37_32), cast<char * const >::from(((char *) ">::invoke\n      <")))),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    {
        ...
        // argI: int
        das_iterator_count DAS_COMMENT((_temp_make_local_39_63_1 = (builtin_count(0,1,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)))))) __argI_iterator(0,1);
        ...
        for ( ; __need_loop_39 ; __need_loop_39 = __argN_iterator.next(__context__,(__argN_rename_at_39_39)) && __argT_iterator.next(__context__,(__argT_rename_at_39_40)) && __argI_iterator.next(__context__,(__argI_rename_at_39_41)) )
        {
            ...
            if ( __argI_rename_at_39_41 == 0 )
            {
                ...
                char * __argtd_rename_at_46_42 = ((char *)(char *)(_FuncastTickdescribe_cppTick8220285150532477039_1f90a5fe82c5b19c(__context__,(*__argT_rename_at_39_40),false,false,false,true,true)));
    ...
    builtin_fwrite(__cpp_file_rename_at_36_29,((char *) ">\n        (__context__,nullptr,__funcCall__,\n          "),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    {
        ...
        // argI: int
        das_iterator_count DAS_COMMENT((_temp_make_local_54_40_2 = (builtin_count(0,1,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)))))) __argI_iterator(0,1);
...
inline void log_cpp_class_adapter_f21d05160c43dfb6 ( Context * __context__, FILE const  * const  __cpp_file_rename_at_66_47, char * const  __name_rename_at_66_48, smart_ptr_raw<TypeDecl> const  __cinfo_rename_at_66_49 )
{
    ...
    Sequence DAS_COMMENT((int32_t)) _temp_make_local_74_46_3; _temp_make_local_74_46_3;
    Sequence DAS_COMMENT((int32_t)) _temp_make_local_85_29_4; _temp_make_local_85_29_4;
    Sequence DAS_COMMENT((int32_t)) _temp_make_local_93_29_5; _temp_make_local_93_29_5;
    /* finally */ auto __finally_66= das_finally([&](){
    _FuncbuiltinTickfinalizeTick13836114024949725080_9761ce31b72a4dea(__context__,das_arg<TArray<smart_ptr_raw<TypeDecl>>>::pass(__types_rename_at_73_51));
    /* end finally */ });
    ...
    das_zero(__types_rename_at_73_51);
    {
        ...
        // idx: int
        das_iterator_count DAS_COMMENT((_temp_make_local_74_46_3 = (builtin_count(0,1,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)))))) __idx_iterator(0,1);
        ...
        for ( ; __need_loop_74 ; __need_loop_74 = __fld_iterator.next(__context__,(__fld_rename_at_74_54)) && __idx_iterator.next(__context__,(__idx_rename_at_74_55)) )
        {
            if ( (!(((das_deref(__context__,(*__fld_rename_at_74_54).type /*_type*/)).isFunction())) || (eq_dstr_str((*__fld_rename_at_74_54).name /*name*/,((char *) "__finalize")))) || (nequ_sptr_ptr(das_auto_cast<smart_ptr_raw<void> const >::cast((*__fld_rename_at_74_54).init /*init*/),das_auto_cast<void * const >::cast(nullptr))) )
            {
                ...
                AutoTuple<char *,int32_t> _temp_make_local_78_23_6; _temp_make_local_78_23_6;
                _FuncbuiltinTickpushTick10769833213962245646_319b6d1f73c6618(__context__,das_arg<TArray<AutoTuple<char *,int32_t>>>::pass(__methods_rename_at_72_50),das_arg<AutoTuple<char *,int32_t>>::pass((([&]() -> AutoTuple<char *,int32_t>& {
                    das_get_auto_tuple_field<char *,0,char *,int32_t>::get(_temp_make_local_78_23_6) = das_string_builder(__context__,SimNode_AotInterop<1>(__tinfo_6, cast<das::string const  &>::from((*__fld_rename_at_74_54).name /*name*/)));
                    das_get_auto_tuple_field<int32_t,1,char *,int32_t>::get(_temp_make_local_78_23_6) = __idx_rename_at_74_55;
                    return _temp_make_local_78_23_6;
                })())));
                _FuncbuiltinTickpush_cloneTick15769051505004837089_abc4184427b0600f(__context__,das_arg<TArray<smart_ptr_raw<TypeDecl>>>::pass(__types_rename_at_73_51),(*__fld_rename_at_74_54).type /*_type*/);
            };
        }
    ...
    builtin_fwrite(__cpp_file_rename_at_66_47,((char *) "  enum {\n"),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    {
        ...
        // mni: int
        das_iterator_count DAS_COMMENT((_temp_make_local_85_29_4 = (builtin_count(0,1,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)))))) __mni_iterator(0,1);
    ...
    builtin_fwrite(__cpp_file_rename_at_66_47,das_string_builder_temp(__context__,SimNode_AotInterop<3>(__tinfo_10, cast<char * const >::from(((char *) "  ")), cast<char * const >::from(__name_rename_at_66_48), cast<char * const >::from(((char *) " ( const StructInfo * info ) {\n")))),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    {
        ...
        // mni: int
        das_iterator_count DAS_COMMENT((_temp_make_local_93_29_5 = (builtin_count(0,1,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)))))) __mni_iterator(0,1);
    ...
    builtin_fwrite(__cpp_file_rename_at_66_47,((char *) "  }\n"),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    {
        ...
        for ( ; __need_loop_97 ; __need_loop_97 = __mn_iterator.next(__context__,(__mn_rename_at_97_67)) && __mt_iterator.next(__context__,(__mt_rename_at_97_68)) )
        {
            ...
            log_cpp_class_method_5ab80ef883f42141(__context__,__cpp_file_rename_at_66_47,das_string_builder(__context__,SimNode_AotInterop<2>(__tinfo_14, cast<char * const >::from(((char *) "invoke_")), cast<char *>::from(das_get_auto_tuple_field<char *,0,char *,int32_t>::get((*__mn_rename_at_97_67))))),(*__mt_rename_at_97_68));
            ...
            log_cpp_class_method_call_b515934edb7d933e(__context__,__cpp_file_rename_at_66_47,das_get_auto_tuple_field<char *,0,char *,int32_t>::get((*__mn_rename_at_97_67)),(*__mt_rename_at_97_68));
            builtin_fwrite(__cpp_file_rename_at_66_47,((char *) ";\n"),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
            builtin_fwrite(__cpp_file_rename_at_66_47,((char *) "  }\n"),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
        }
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x5354b11f2850b190] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&clone_cb8a04c305a6468d>>();
    };
    aotLib[0xb3c537accc32e5cd] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickfinalizeTick13836114024949725080_9761ce31b72a4dea>>();
    };
    aotLib[0x527dccb5c1fc5289] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickdescribe_cppTick8220285150532477039_1f90a5fe82c5b19c>>();
    };
    aotLib[0x94e7dfe2a2a69163] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_319b6d1f73c6618>>();
    };
    aotLib[0xa913edd281696221] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpush_cloneTick15769051505004837089_abc4184427b0600f>>();
    };
    aotLib[0x6f6803d30c8878b7] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&log_cpp_class_method_5ab80ef883f42141>>();
    };
    aotLib[0x53b3beacbf11138f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&log_cpp_class_method_call_b515934edb7d933e>>();
    };
    aotLib[0x6bb93dd94edc5380] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&log_cpp_class_adapter_f21d05160c43dfb6>>();
    };
    resolveTypeInfoAnnotations();
}

} // namespace _anon_1201499517613448361
AotListBase impl_aot_cpp_bind(_anon_1201499517613448361::registerAotFunctions);
} // namespace das
