...
inline void _FuncbuiltinTickpushTick10769833213962245646_c8d9712d05ed21f5 ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_5, ast::AstFunctionAnnotation * __value_rename_at_181_6 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_d65be75c32cb2a14 ( Context * __context__, typemacro_boost::TypeMacroMacro const  & __cl_rename_at_116_7 );
...
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_e642ab9ce760aca1 ( Context * __context__, int32_t __value_rename_at_882_20 );
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_b7af9dc1ef58f6e3 ( Context * __context__, char * const  __value_rename_at_882_21 );
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_6e8b76ea21395e3e ( Context * __context__, smart_ptr_raw<Expression> const  __src_rename_at_1777_26 );
inline Structure * _FuncbuiltinTickget_ptrTick5807679485210906136_4720c1e860381b04 ( Context * __context__, smart_ptr_raw<Structure> __src_rename_at_1765_28 );
...
inline TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>> _FuncbuiltinTickto_array_moveTick3185538323411982277_c420d97e8e0951bf ( Context * __context__, TDim<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>,1> &  __a_rename_at_1375_18 )
{
    ...
    _FuncbuiltinTickresizeTick4811697762258667383_a94de307e15b958a(__context__,das_arg<TArray<AutoTuple<char *,AutoVariant<bool,int32_t,uint32_t,int64_t,uint64_t,float,double,char *,vec4f>>>>::pass(__arr_rename_at_1377_19),1);
...
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_e642ab9ce760aca1 ( Context * __context__, int32_t __value_rename_at_882_20 )
{
    ...
    return /* <- */ das_auto_cast_move<smart_ptr_raw<Expression>>::cast(das_invoke_function<smart_ptr_raw<Expression>>::invoke<int32_t,LineInfo const  &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@typemacro_boost::ast_boost`convert_to_expression`16483834305137942954 C=Xi CH<rtti::LineInfo>*/ 0x343360d074394baf)),__value_rename_at_882_20,das_arg<LineInfo>::pass((_temp_make_local_883_43_0 = (/*c-tor*/ LineInfo(/*end-c-tor*/))))));
}

inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_b7af9dc1ef58f6e3 ( Context * __context__, char * const  __value_rename_at_882_21 )
{
    LineInfo _temp_make_local_883_43_1; _temp_make_local_883_43_1;
    return /* <- */ das_auto_cast_move<smart_ptr_raw<Expression>>::cast(das_invoke_function<smart_ptr_raw<Expression>>::invoke<char * const ,LineInfo const  &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@typemacro_boost::ast_boost`convert_to_expression`16483834305137942954 C=Xs CH<rtti::LineInfo>*/ 0x2103cf52d005bbd9)),__value_rename_at_882_21,das_arg<LineInfo>::pass((_temp_make_local_883_43_1 = (/*c-tor*/ LineInfo(/*end-c-tor*/))))));
}
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_6e8b76ea21395e3e ( Context * __context__, smart_ptr_raw<Expression> const  __src_rename_at_1777_26 )
{
    smart_ptr_raw<Expression> __dst_rename_at_1779_27; das_zero(__dst_rename_at_1779_27); das_move(__dst_rename_at_1779_27, _FuncbuiltinTickclone_to_moveTick2007252383599261567_74801c65ebf67e5e(__context__,das_cast<smart_ptr_raw<Expression>>::cast(__src_rename_at_1777_26)));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x9507d57e2ada05f1] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_c8d9712d05ed21f5>>();
    };
    aotLib[0x14fe57ee8cc74f46] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_d65be75c32cb2a14>>();
    };
    ...
    aotLib[0x3ec2b82e0a8690b2] = +[](Context & ctx) -> SimNode* {
    ...
    aotLib[0x14d2319ef02b1820] = +[](Context & ctx) -> SimNode* {
