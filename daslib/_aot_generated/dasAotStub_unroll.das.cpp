...
namespace das {
namespace _anon_8101909924866969536 {
...
inline void _FuncbuiltinTickpushTick10769833213962245646_ed3c13f857f92566 ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_0, ast::AstFunctionAnnotation * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_79e7a3c6fc22f61e ( Context * __context__, unroll::UnrollMacro const  & __cl_rename_at_116_2 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_e7dd1238a34d8d2a ( Context * __context__, char * const  __name_rename_at_631_3, unroll::UnrollMacro * __someClassPtr_rename_at_631_4 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_4073b4495d6a39ea ( Context * __context__, char * const  __name_rename_at_273_6, char * const  __tag_rename_at_273_7, unroll::UnrollMacro * __classPtr_rename_at_273_8 );
inline void unroll_57edb0117ddead9f ( Context * __context__, Block DAS_COMMENT((void)) const  & __blk_rename_at_15_10 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_e7dd1238a34d8d2a ( Context * __context__, char * const  __name_rename_at_631_3, unroll::UnrollMacro * __someClassPtr_rename_at_631_4 )
{
    _FuncbuiltinTickpushTick10769833213962245646_ed3c13f857f92566(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_631_4));
    StructInfo const  * __classInfo_rename_at_634_5 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_79e7a3c6fc22f61e(__context__,das_arg<unroll::UnrollMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_631_4))));
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_4073b4495d6a39ea ( Context * __context__, char * const  __name_rename_at_273_6, char * const  __tag_rename_at_273_7, unroll::UnrollMacro * __classPtr_rename_at_273_8 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_9; das_zero(__ann_rename_at_274_9); das_move(__ann_rename_at_274_9, _FuncastTickmake_function_annotationTick3074191368936885601_e7dd1238a34d8d2a(__context__,__name_rename_at_273_6,__classPtr_rename_at_273_8));
...
inline void unroll_57edb0117ddead9f ( Context * __context__, Block DAS_COMMENT((void)) const  &  __blk_rename_at_15_10 )
{
    das_invoke<void>::invoke(__context__,nullptr,__blk_rename_at_15_10);
}

static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x2fe6dc56c3c216da] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_ed3c13f857f92566>>();
    };
    aotLib[0x869bb13c98ce314f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_79e7a3c6fc22f61e>>();
    };
    aotLib[0xc36965d5eb509fbf] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_function_annotationTick3074191368936885601_e7dd1238a34d8d2a>>();
    };
    aotLib[0x163d37911d9cb61] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_4073b4495d6a39ea>>();
    };
    aotLib[0x1766e9a1f5f8f59e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&unroll_57edb0117ddead9f>>();
    };
    // [[ init script ]]
...
AotListBase impl_aot_unroll(_anon_8101909924866969536::registerAotFunctions);
} // namespace das
