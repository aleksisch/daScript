...
inline void finalize_bed9346ca850070b ( Context * __context__, AutoTuple<char *,char *> & ____this_rename_at_1219_0 );
...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_7f53f4642f195f50 ( Context * __context__, TArray<AutoTuple<char *,char *>> & __a_rename_at_1215_4 );
...
inline Sequence DAS_COMMENT((char *)) _FuncbuiltinTickkeysTick2205854368403803976_68cc1d3f65aa5e37 ( Context * __context__, TTable<char *,char *> const  & __a_rename_at_1161_8 );
inline Sequence DAS_COMMENT((char * &)) _FuncbuiltinTickvaluesTick1935193042646774172_905c0870e0561113 ( Context * __context__, TTable<char *,char *> const  & __a_rename_at_1176_10 );
inline void _FuncbuiltinTicksortTick5995501125257068354_c8839d86b09e54e ( Context * __context__, TArray<AutoTuple<char *,char *>> & __a_rename_at_1609_12, Block DAS_COMMENT((bool,AutoTuple<char *,char *> const ,AutoTuple<char *,char *> const )) const  & __cmp_rename_at_1609_13 );
inline TArray<char *> uri_split_full_path_66fbda593c42e244 ( Context * __context__, Uri const  & __uri_rename_at_14_14 );
...
inline char * scheme_c9e107a874b1338e ( Context * __context__, Uri const  & __uri_rename_at_77_36 );
inline char * user_info_ba743c5bbdbc4b8a ( Context * __context__, Uri const  & __uri_rename_at_82_37 );
inline char * host_1f165f069b89104e ( Context * __context__, Uri const  & __uri_rename_at_87_38 );
inline char * port_2a2ab9636ea07796 ( Context * __context__, Uri const  & __uri_rename_at_92_39 );
inline char * path_f6cfbb959e363c34 ( Context * __context__, Uri const  & __uri_rename_at_97_40 );
inline char * query_a1da36dca0c5f786 ( Context * __context__, Uri const  & __uri_rename_at_114_44 );
inline char * fragment_8c34c878643bd26b ( Context * __context__, Uri const  & __uri_rename_at_119_45 );
inline Uri uri_compose_ad4d0e198ec62589 ( Context * __context__, char * const  __scheme_rename_at_124_46, char * const  __userInfo_rename_at_124_47, char * const  __hostText_rename_at_124_48, char * const  __portText_rename_at_124_49, char * const  __path_rename_at_124_50, char * const  __query_rename_at_124_51, char * const  __fragment_rename_at_124_52 );
...
{
    {
        ...
        {
            finalize_bed9346ca850070b(__context__,das_arg<AutoTuple<char *,char *>>::pass((*__aV_rename_at_1217_5)));
        }
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xe513e807dc3e592d] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&uri_split_full_path_66fbda593c42e244>>();
    };
    ...
    aotLib[0xcc7d78cea4f8c03b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&scheme_c9e107a874b1338e>>();
    };
    aotLib[0x2a3bf90bab41d136] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&user_info_ba743c5bbdbc4b8a>>();
    };
    aotLib[0x6bb73be95d6e1f96] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&host_1f165f069b89104e>>();
    };
    aotLib[0xb35b55a7c12296ee] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&port_2a2ab9636ea07796>>();
    };
    aotLib[0x67183a73e4b35bed] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&path_f6cfbb959e363c34>>();
    };
    aotLib[0x861adadd323ae55e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&query_a1da36dca0c5f786>>();
    };
    aotLib[0x3d917a54b7e07fcf] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fragment_8c34c878643bd26b>>();
    };
    aotLib[0xd26154d0367e5849] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&uri_compose_ad4d0e198ec62589>>();
    };
