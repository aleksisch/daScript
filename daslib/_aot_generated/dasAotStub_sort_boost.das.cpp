...
namespace das {
namespace _anon_3025658887001802241 {
...
inline void _FuncbuiltinTickpushTick10769833213962245646_c4ea023f32492345 ( Context * __context__, TArray<ast::AstCallMacro *> & __Arr_rename_at_181_0, ast::AstCallMacro * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_34f45f9587f05b2b ( Context * __context__, sort_boost::QsortMacro const  & __cl_rename_at_116_2 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x52dbb12366343605] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_c4ea023f32492345>>();
    };
    aotLib[0xb5f6fb3d626c3d36] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_34f45f9587f05b2b>>();
    };
    resolveTypeInfoAnnotations();
}

} // namespace _anon_3025658887001802241
AotListBase impl_aot_sort_boost(_anon_3025658887001802241::registerAotFunctions);
} // namespace das
