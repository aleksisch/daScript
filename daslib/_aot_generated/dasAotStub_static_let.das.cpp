...
inline void finalize_aada8fc8749ebe98 ( Context * __context__, AutoTuple<char *,char *> & ____this_rename_at_1219_0 );
inline void _FuncbuiltinTickpushTick10769833213962245646_31d62d8968aafbf7 ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_1, ast::AstFunctionAnnotation * __value_rename_at_181_2 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_76b01503a4c4edbe ( Context * __context__, static_let::StaticLetMacro const  & __cl_rename_at_116_3 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_f64aa67f30393b9d ( Context * __context__, char * const  __name_rename_at_631_4, static_let::StaticLetMacro * __someClassPtr_rename_at_631_5 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_54aa55563e419d3f ( Context * __context__, TArray<AutoTuple<char *,char *>> & __a_rename_at_1215_7 );
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_f9128f88fbacf91d ( Context * __context__, char * const  __name_rename_at_273_11, char * const  __tag_rename_at_273_12, static_let::StaticLetMacro * __classPtr_rename_at_273_13 );
...
inline bool make_shutdown_function_35575fe2e7024abc ( Context * __context__, char * const  __varname_rename_at_27_17, LineInfo const  & __at_rename_at_27_18 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_f64aa67f30393b9d ( Context * __context__, char * const  __name_rename_at_631_4, static_let::StaticLetMacro * __someClassPtr_rename_at_631_5 )
{
    _FuncbuiltinTickpushTick10769833213962245646_31d62d8968aafbf7(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_631_5));
    StructInfo const  * __classInfo_rename_at_634_6 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_76b01503a4c4edbe(__context__,das_arg<static_let::StaticLetMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_631_5))));
...
{
    {
        ...
        {
            finalize_aada8fc8749ebe98(__context__,das_arg<AutoTuple<char *,char *>>::pass((*__aV_rename_at_1217_8)));
        }
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_f9128f88fbacf91d ( Context * __context__, char * const  __name_rename_at_273_11, char * const  __tag_rename_at_273_12, static_let::StaticLetMacro * __classPtr_rename_at_273_13 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_14; das_zero(__ann_rename_at_274_14); das_move(__ann_rename_at_274_14, _FuncastTickmake_function_annotationTick3074191368936885601_f64aa67f30393b9d(__context__,__name_rename_at_273_11,__classPtr_rename_at_273_13));
    das_invoke_function<void>::invoke<char * const ,smart_ptr_raw<FunctionAnnotation>>(__context__,nullptr,Func(__context__->fnByMangledName(/*@ast_boost::apply_tag_annotation Cs Y<FunctionAnnotationPtr>1<H<ast::FunctionAnnotation>>?M*/ 0x7678364e276db9c2)),__tag_rename_at_273_12,__ann_rename_at_274_14);
    addModuleFunctionAnnotation(thisModule(__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL))),__ann_rename_at_274_14,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
inline bool make_shutdown_function_35575fe2e7024abc ( Context * __context__, char * const  __varname_rename_at_27_17, LineInfo const  &  __at_rename_at_27_18 ) { das_stack_prologue __prologue(__context__,288,"make_shutdown_function " DAS_FILE_LINE);
{
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x7e8f6663bede62c2] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_31d62d8968aafbf7>>();
    };
    aotLib[0xb025a83bb5e723a3] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_76b01503a4c4edbe>>();
    };
    aotLib[0x3086cb5c5428d8bd] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_function_annotationTick3074191368936885601_f64aa67f30393b9d>>();
    };
    ...
    aotLib[0xa353aec0e57a0dff] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_f9128f88fbacf91d>>();
    };
    ...
    aotLib[0x69b17512b7e1c98c] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&make_shutdown_function_35575fe2e7024abc>>();
    };
    // [[ init script ]]
