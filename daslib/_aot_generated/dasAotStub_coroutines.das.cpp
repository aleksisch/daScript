...
inline void _FuncbuiltinTickpushTick10769833213962245646_db3e2702d89da7ae ( Context * __context__, TArray<ast::AstCallMacro *> & __Arr_rename_at_181_2, ast::AstCallMacro * __value_rename_at_181_3 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_9c40da4286e6fbd ( Context * __context__, coroutines::YieldFrom const  & __cl_rename_at_116_4 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_caa0c7ccd88dd6d2 ( Context * __context__, coroutines::CoContinue const  & __cl_rename_at_116_5 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_6adb748bbeaaddaf ( Context * __context__, coroutines::CoAwait const  & __cl_rename_at_116_6 );
inline void _FuncbuiltinTickpushTick10769833213962245646_50451a1540cfbcae ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_7, ast::AstFunctionAnnotation * __value_rename_at_181_8 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_c7c33c5b8e9324a6 ( Context * __context__, coroutines::CoroutineMacro const  & __cl_rename_at_116_9 );
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_8bf5e9405e0d6e78 ( Context * __context__, smart_ptr_raw<Expression> const  __src_rename_at_1777_12 );
inline bool _FuncbuiltinTicknextTick17450348357676149856_cb9ff6dafc5d0363 ( Context * __context__, Sequence DAS_COMMENT((bool)) & __it_rename_at_1256_14, bool & __value_rename_at_1256_15 );
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_8bf5e9405e0d6e78 ( Context * __context__, smart_ptr_raw<Expression> const  __src_rename_at_1777_12 )
{
    smart_ptr_raw<Expression> __dst_rename_at_1779_13; das_zero(__dst_rename_at_1779_13); das_move(__dst_rename_at_1779_13, _FuncbuiltinTickclone_to_moveTick2007252383599261567_77628aa1049d89f3(__context__,das_cast<smart_ptr_raw<Expression>>::cast(__src_rename_at_1777_12)));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<Expression>>::cast(__dst_rename_at_1779_13);
}

inline bool _FuncbuiltinTicknextTick17450348357676149856_cb9ff6dafc5d0363 ( Context * __context__, Sequence DAS_COMMENT((bool)) &  __it_rename_at_1256_14, bool & __value_rename_at_1256_15 )
{
    return das_auto_cast<bool>::cast(builtin_iterator_iterate(das_arg<Sequence DAS_COMMENT((bool))>::pass(__it_rename_at_1256_14),das_auto_cast<void * const >::cast(das_ref(__context__,__value_rename_at_1256_15)),__context__));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x65edfe99da9c6d6a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_db3e2702d89da7ae>>();
    };
    aotLib[0x9be9bd264ed3781e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_9c40da4286e6fbd>>();
    };
    aotLib[0xcad05fcd1a3c2aa8] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_caa0c7ccd88dd6d2>>();
    };
    aotLib[0xe2c40a43b1dc2a14] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_6adb748bbeaaddaf>>();
    };
    aotLib[0x7b3bdc39d65377fb] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_50451a1540cfbcae>>();
    };
    aotLib[0x3c70e1f292c2b229] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_c7c33c5b8e9324a6>>();
    };
