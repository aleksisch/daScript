...
inline void fuzz_numeric_and_vector_op1_2b4f45aa5b77fc01 ( Context * __context__, testing::T * const  __t_rename_at_58_10, faker::Faker & __fake_rename_at_58_11, char * const  __funcname_rename_at_58_12 );
inline void fuzz_numeric_and_vector_signed_op1_1a57c46ff9049dfe ( Context * __context__, testing::T * const  __t_rename_at_77_13, faker::Faker & __fake_rename_at_77_14, char * const  __funcname_rename_at_77_15 );
inline void fuzz_numeric_op1_1a71945cf33b1d16 ( Context * __context__, testing::T * const  __t_rename_at_92_16, faker::Faker & __fake_rename_at_92_17, char * const  __funcname_rename_at_92_18 );
inline void fuzz_numeric_and_storage_op1_964aa0b6c3f81f48 ( Context * __context__, testing::T * const  __t_rename_at_102_19, faker::Faker & __fake_rename_at_102_20, char * const  __funcname_rename_at_102_21 );
inline void fuzz_all_ints_op1_c1e4a4e065b461ad ( Context * __context__, testing::T * const  __t_rename_at_118_22, faker::Faker & __fake_rename_at_118_23, char * const  __funcname_rename_at_118_24 );
inline void fuzz_all_unsigned_ints_op1_758adaa194dd422b ( Context * __context__, testing::T * const  __t_rename_at_128_25, faker::Faker & __fake_rename_at_128_26, char * const  __funcname_rename_at_128_27 );
inline void fuzz_float_double_or_float_vec_op1_7f644fa9ac36609e ( Context * __context__, testing::T * const  __t_rename_at_136_28, faker::Faker & __fake_rename_at_136_29, char * const  __funcname_rename_at_136_30 );
inline void fuzz_float_or_float_vec_op1_a4c128da34d297bd ( Context * __context__, testing::T * const  __t_rename_at_147_31, faker::Faker & __fake_rename_at_147_32, char * const  __funcname_rename_at_147_33 );
inline void fuzz_float_or_float_vec_op2_4a26b5ba0673d45a ( Context * __context__, testing::T * const  __t_rename_at_157_34, faker::Faker & __fake_rename_at_157_35, char * const  __funcname_rename_at_157_36 );
inline void fuzz_float_double_or_float_vec_op2_f2dfd300c4a4e972 ( Context * __context__, testing::T * const  __t_rename_at_167_37, faker::Faker & __fake_rename_at_167_38, char * const  __funcname_rename_at_167_39 );
inline void fuzz_numeric_and_vector_op2_bea93694fad4a499 ( Context * __context__, testing::T * const  __t_rename_at_178_40, faker::Faker & __fake_rename_at_178_41, char * const  __funcname_rename_at_178_42 );
inline void fuzz_numeric_and_vector_op2_no_unint_vec_cdf1c7e4d6012a04 ( Context * __context__, testing::T * const  __t_rename_at_197_43, faker::Faker & __fake_rename_at_197_44, char * const  __funcname_rename_at_197_45 );
inline void fuzz_numeric_op2_b7df987a6a03ef2c ( Context * __context__, testing::T * const  __t_rename_at_214_46, faker::Faker & __fake_rename_at_214_47, char * const  __funcname_rename_at_214_48 );
inline void fuzz_compareable_op2_c1775dccf5196e88 ( Context * __context__, testing::T * const  __t_rename_at_224_49, faker::Faker & __fake_rename_at_224_50, char * const  __funcname_rename_at_224_51 );
inline void fuzz_eq_neq_op2_99ee03ee1ded65b3 ( Context * __context__, testing::T * const  __t_rename_at_237_52, faker::Faker & __fake_rename_at_237_53, char * const  __funcname_rename_at_237_54 );
inline void fuzz_numeric_vec_scal_op2_c5d52e5abe5277a0 ( Context * __context__, testing::T * const  __t_rename_at_259_55, faker::Faker & __fake_rename_at_259_56, char * const  __funcname_rename_at_259_57 );
inline void fuzz_numeric_scal_vec_op2_53339b0779a34464 ( Context * __context__, testing::T * const  __t_rename_at_274_58, faker::Faker & __fake_rename_at_274_59, char * const  __funcname_rename_at_274_60 );
inline void fuzz_int_vector_op2_8fb3058976ac0df3 ( Context * __context__, testing::T * const  __t_rename_at_289_61, faker::Faker & __fake_rename_at_289_62, char * const  __funcname_rename_at_289_63 );
inline void fuzz_shift_op2_6204dbce2c561463 ( Context * __context__, testing::T * const  __t_rename_at_303_64, faker::Faker & __fake_rename_at_303_65, char * const  __funcname_rename_at_303_66 );
inline void fuzz_rotate_op2_904e9ac83ca53979 ( Context * __context__, testing::T * const  __t_rename_at_317_67, faker::Faker & __fake_rename_at_317_68, char * const  __funcname_rename_at_317_69 );
inline void fuzz_numeric_op3_cafec02757f7e84d ( Context * __context__, testing::T * const  __t_rename_at_325_70, faker::Faker & __fake_rename_at_325_71, char * const  __funcname_rename_at_325_72 );
inline void fuzz_vec_op3_745cb465175557d4 ( Context * __context__, testing::T * const  __t_rename_at_335_73, faker::Faker & __fake_rename_at_335_74, char * const  __funcname_rename_at_335_75 );
inline void fuzz_vec_mad_op3_165c11e26da046ba ( Context * __context__, testing::T * const  __t_rename_at_350_76, faker::Faker & __fake_rename_at_350_77, char * const  __funcname_rename_at_350_78 );
inline void fuzz_float_double_or_float_vec_op3_6fe9e7c1ee7daf52 ( Context * __context__, testing::T * const  __t_rename_at_365_79, faker::Faker & __fake_rename_at_365_80, char * const  __funcname_rename_at_365_81 );
inline void fuzz_numeric_op4_8094057c0802f995 ( Context * __context__, testing::T * const  __t_rename_at_377_82, faker::Faker & __fake_rename_at_377_83, char * const  __funcname_rename_at_377_84 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xff0b8c3a38ddab3d] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_numeric_and_vector_op1_2b4f45aa5b77fc01>>();
    };
    aotLib[0x6c7d416f16eaa748] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_numeric_and_vector_signed_op1_1a57c46ff9049dfe>>();
    };
    aotLib[0x46f9466daafdf0c9] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_numeric_op1_1a71945cf33b1d16>>();
    };
    aotLib[0x14719766236d3f05] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_numeric_and_storage_op1_964aa0b6c3f81f48>>();
    };
    aotLib[0x352ad4d0f4bce05b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_all_ints_op1_c1e4a4e065b461ad>>();
    };
    aotLib[0x9587e644e60b1d06] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_all_unsigned_ints_op1_758adaa194dd422b>>();
    };
    aotLib[0x580691a3deb9e0fc] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_float_double_or_float_vec_op1_7f644fa9ac36609e>>();
    };
    aotLib[0x807df1ecc9d21859] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_float_or_float_vec_op1_a4c128da34d297bd>>();
    };
    aotLib[0xa82b2b4f15db8f35] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_float_or_float_vec_op2_4a26b5ba0673d45a>>();
    };
    aotLib[0x4b9cdfe3a6917438] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_float_double_or_float_vec_op2_f2dfd300c4a4e972>>();
    };
    aotLib[0x91c339e6cdfe822a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_numeric_and_vector_op2_bea93694fad4a499>>();
    };
    aotLib[0x5d6a1211f8b516c9] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_numeric_and_vector_op2_no_unint_vec_cdf1c7e4d6012a04>>();
    };
    aotLib[0x58735707055f3181] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_numeric_op2_b7df987a6a03ef2c>>();
    };
    aotLib[0x70d4b0192422d027] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_compareable_op2_c1775dccf5196e88>>();
    };
    aotLib[0x9037237ac3f9b9d2] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_eq_neq_op2_99ee03ee1ded65b3>>();
    };
    aotLib[0xa4429ce5eb94d293] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_numeric_vec_scal_op2_c5d52e5abe5277a0>>();
    };
    aotLib[0xe16368eed55720c6] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_numeric_scal_vec_op2_53339b0779a34464>>();
    };
    aotLib[0xb51cb65d1bd30a95] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_int_vector_op2_8fb3058976ac0df3>>();
    };
    aotLib[0xcf991a397d7017cf] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_shift_op2_6204dbce2c561463>>();
    };
    aotLib[0x18622fa525382ad9] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_rotate_op2_904e9ac83ca53979>>();
    };
    aotLib[0x9f4028380b3572d0] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_numeric_op3_cafec02757f7e84d>>();
    };
    aotLib[0xedef29477aa0cdd] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_vec_op3_745cb465175557d4>>();
    };
    aotLib[0x97d603716cb6139c] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_vec_mad_op3_165c11e26da046ba>>();
    };
    aotLib[0x59ece560ce0e26ab] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_float_double_or_float_vec_op3_6fe9e7c1ee7daf52>>();
    };
    aotLib[0x5ed7d9a9e644a09c] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&fuzz_numeric_op4_8094057c0802f995>>();
    };
    // [[ init script ]]
