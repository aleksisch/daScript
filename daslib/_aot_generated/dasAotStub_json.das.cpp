...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_118143448cef53b4 ( Context * __context__, TArray<uint8_t> & __a_rename_at_1215_0 );
inline void finalize_ad8689b2c3216ff3 ( Context * __context__, json::_lambda_json_99_1 & ____this_rename_at_99_1 );
inline Sequence DAS_COMMENT((json::TokenAt)) _FuncbuiltinTickeachTick9663565701927713696_f82670fc7e714dfa ( Context * __context__, Lambda DAS_COMMENT((bool,json::TokenAt)) const  __lam_rename_at_1322_2 );
inline bool _FuncbuiltinTicknextTick17450348357676149856_80eac3dd8d64249e ( Context * __context__, Sequence DAS_COMMENT((int32_t)) & __it_rename_at_1256_4, int32_t & __value_rename_at_1256_5 );
inline Sequence DAS_COMMENT((int32_t)) _FuncbuiltinTickeachTick4044332007967089362_b9a088e792341ef2 ( Context * __context__, char * const  __str_rename_at_1289_6 );
...
inline bool _FuncbuiltinTicknextTick17450348357676149856_e247a8d469c511cc ( Context * __context__, Sequence DAS_COMMENT((json::TokenAt)) & __it_rename_at_1256_13, json::TokenAt & __value_rename_at_1256_14 );
...
inline Sequence DAS_COMMENT((char *)) _FuncbuiltinTickkeysTick2205854368403803976_5d08049ff7d797e2 ( Context * __context__, TTable<char *,json::JsonValue *> const  & __a_rename_at_1161_22 );
inline Sequence DAS_COMMENT((json::JsonValue * &)) _FuncbuiltinTickvaluesTick1935193042646774172_e8953d3b3cbab6d5 ( Context * __context__, TTable<char *,json::JsonValue *> const  & __a_rename_at_1176_24 );
