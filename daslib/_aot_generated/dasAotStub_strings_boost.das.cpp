...
inline void _FuncbuiltinTickcloneTick3038771811667655495_7e81813bcc98f6c7 ( Context * __context__, TArray<char *> & __a_rename_at_1142_5, TArray<char *> const  & __b_rename_at_1142_6 );
...
inline void _FuncbuiltinTickswapTick6899974565646937647_30e37cee9b54428 ( Context * __context__, TArray<int32_t> & __a_rename_at_1961_16, TArray<int32_t> & __b_rename_at_1961_17 );
inline bool _FuncbuiltinTickemptyTick15399874715904164783_a2b1908396a6ed79 ( Context * __context__, TArray<TTuple<16,char *,char *>> const  & __a_rename_at_602_19 );
inline char * wide_53059f73cffda483 ( Context * __context__, char * const  __text_rename_at_18_20, int32_t __width_rename_at_18_21 );
inline TArray<char *> split_815bca29e5ea3727 ( Context * __context__, char * const  __text_rename_at_111_23, char * const  __delim_rename_at_111_24 );
inline TArray<char *> split_by_chars_47006a727f2aaba8 ( Context * __context__, char * const  __text_rename_at_126_27, char * const  __delim_rename_at_126_28 );
inline int32_t levenshtein_distance_549bdedc98dec005 ( Context * __context__, char * const  __s_rename_at_155_31, char * const  __t_rename_at_155_32 );
inline int32_t levenshtein_distance_fast_a9a12a715bbf1d10 ( Context * __context__, char * const  __s_rename_at_182_41, char * const  __t_rename_at_182_42 );
inline char * replace_multiple_1da40d13c4a4caa0 ( Context * __context__, char * const  __source_rename_at_210_53, TArray<TTuple<16,char *,char *>> const  & __replaces_rename_at_210_54 );
inline bool contains_b393616ecb73d32c ( Context * __context__, char * const  __str_rename_at_237_60, char * const  __sub_rename_at_237_61 );
inline int32_t count_f1b1310311a77129 ( Context * __context__, char * const  __str_rename_at_242_62, char * const  __sub_rename_at_242_63 );
inline int32_t last_index_of_68a66f257a1281ba ( Context * __context__, char * const  __str_rename_at_258_67, char * const  __sub_rename_at_258_68 );
inline int32_t last_index_of_d79904c391afb2d3 ( Context * __context__, char * const  __str_rename_at_272_71, char * const  __sub_rename_at_272_72, int32_t __start_rename_at_272_73 );
inline char * pad_right_a3ec73a8713839a4 ( Context * __context__, char * const  __str_rename_at_286_76, int32_t __width_rename_at_286_77, int32_t __ch_rename_at_286_78 );
inline char * pad_left_efdec77e951364ac ( Context * __context__, char * const  __str_rename_at_299_81, int32_t __width_rename_at_299_82, int32_t __ch_rename_at_299_83 );
...
inline char * capitalize_32905318c4f7df49 ( Context * __context__, char * const  __str_rename_at_330_90 );
...
inline void _FuncbuiltinTickswapTick6899974565646937647_30e37cee9b54428 ( Context * __context__, TArray<int32_t> &  __a_rename_at_1961_16, TArray<int32_t> &  __b_rename_at_1961_17 )
{
    TArray<int32_t> __t_rename_at_1963_18; das_zero(__t_rename_at_1963_18); das_move(__t_rename_at_1963_18, __a_rename_at_1961_16);
    das_move(__a_rename_at_1961_16,__b_rename_at_1961_17);
    das_move(__b_rename_at_1961_17,__t_rename_at_1963_18);
}
...
inline TArray<char *> split_815bca29e5ea3727 ( Context * __context__, char * const  __text_rename_at_111_23, char * const  __delim_rename_at_111_24 ) { das_stack_prologue __prologue(__context__,96,"split " DAS_FILE_LINE);
{
    ...
    builtin_string_split(__text_rename_at_111_23,__delim_rename_at_111_24,das_make_block<void,TArray<char *> const  &>(__context__,80,0,&__func_info__d23ecd373e379628,[&](TArray<char *> const  & __arr_rename_at_114_26) -> void{
        _FuncbuiltinTickcloneTick3038771811667655495_7e81813bcc98f6c7(__context__,das_arg<TArray<char *>>::pass(__res_rename_at_113_25),__arr_rename_at_114_26);
    }),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
    return /* <- */ das_auto_cast_move<TArray<char *>>::cast(__res_rename_at_113_25);
}}

inline TArray<char *> split_by_chars_47006a727f2aaba8 ( Context * __context__, char * const  __text_rename_at_126_27, char * const  __delim_rename_at_126_28 ) { das_stack_prologue __prologue(__context__,96,"split_by_chars " DAS_FILE_LINE);
{
    ...
    builtin_string_split_by_char(__text_rename_at_126_27,__delim_rename_at_126_28,das_make_block<void,TArray<char *> const  &>(__context__,80,0,&__func_info__d23ecd373e379628,[&](TArray<char *> const  & __arr_rename_at_129_30) -> void{
        _FuncbuiltinTickcloneTick3038771811667655495_7e81813bcc98f6c7(__context__,das_arg<TArray<char *>>::pass(__res_rename_at_128_29),__arr_rename_at_129_30);
    }),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
...
static vec4f __wrap__FuncbuiltinTickcloneTick3038771811667655495_7e81813bcc98f6c7 ( Context * __context__ ) {
    ...
    _FuncbuiltinTickcloneTick3038771811667655495_7e81813bcc98f6c7(__context__, arg_a, arg_b);
    return v_zero();
}
...
static vec4f __wrap__FuncbuiltinTickemptyTick15399874715904164783_a2b1908396a6ed79 ( Context * __context__ ) {
    ...
    return cast<bool>::from(_FuncbuiltinTickemptyTick15399874715904164783_a2b1908396a6ed79(__context__, arg_a));
}
...
static vec4f __wrap_split_815bca29e5ea3727 ( Context * __context__ ) {
    char * const  arg_text = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[0]);
    char * const  arg_delim = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[1]);
    *((TArray<char *> *) __context__->abiCMRES) = split_815bca29e5ea3727(__context__, arg_text, arg_delim);
    return v_zero();
}
static vec4f __wrap_split_by_chars_47006a727f2aaba8 ( Context * __context__ ) {
    char * const  arg_text = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[0]);
    char * const  arg_delim = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[1]);
    *((TArray<char *> *) __context__->abiCMRES) = split_by_chars_47006a727f2aaba8(__context__, arg_text, arg_delim);
    return v_zero();
}
...
static vec4f __wrap_levenshtein_distance_fast_a9a12a715bbf1d10 ( Context * __context__ ) {
    char * const  arg_s = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[0]);
    char * const  arg_t = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[1]);
    return cast<int32_t>::from(levenshtein_distance_fast_a9a12a715bbf1d10(__context__, arg_s, arg_t));
}
static vec4f __wrap_replace_multiple_1da40d13c4a4caa0 ( Context * __context__ ) {
    ...
    return cast<char *>::from(replace_multiple_1da40d13c4a4caa0(__context__, arg_source, arg_replaces));
}
static vec4f __wrap_contains_b393616ecb73d32c ( Context * __context__ ) {
    ...
    return cast<bool>::from(contains_b393616ecb73d32c(__context__, arg_str, arg_sub));
}
static vec4f __wrap_count_f1b1310311a77129 ( Context * __context__ ) {
    char * const  arg_str = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[0]);
    char * const  arg_sub = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[1]);
    return cast<int32_t>::from(count_f1b1310311a77129(__context__, arg_str, arg_sub));
}
static vec4f __wrap_last_index_of_68a66f257a1281ba ( Context * __context__ ) {
    char * const  arg_str = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[0]);
    char * const  arg_sub = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[1]);
    return cast<int32_t>::from(last_index_of_68a66f257a1281ba(__context__, arg_str, arg_sub));
}
static vec4f __wrap_last_index_of_d79904c391afb2d3 ( Context * __context__ ) {
    char * const  arg_str = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[0]);
    char * const  arg_sub = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[1]);
    int32_t arg_start = cast_aot_arg<int32_t>::to(*__context__,__context__->abiArguments()[2]);
    return cast<int32_t>::from(last_index_of_d79904c391afb2d3(__context__, arg_str, arg_sub, arg_start));
}
static vec4f __wrap_pad_right_a3ec73a8713839a4 ( Context * __context__ ) {
    char * const  arg_str = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[0]);
    int32_t arg_width = cast_aot_arg<int32_t>::to(*__context__,__context__->abiArguments()[1]);
    int32_t arg_ch = cast_aot_arg<int32_t>::to(*__context__,__context__->abiArguments()[2]);
    return cast<char *>::from(pad_right_a3ec73a8713839a4(__context__, arg_str, arg_width, arg_ch));
}
static vec4f __wrap_pad_left_efdec77e951364ac ( Context * __context__ ) {
    char * const  arg_str = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[0]);
    int32_t arg_width = cast_aot_arg<int32_t>::to(*__context__,__context__->abiArguments()[1]);
    int32_t arg_ch = cast_aot_arg<int32_t>::to(*__context__,__context__->abiArguments()[2]);
    return cast<char *>::from(pad_left_efdec77e951364ac(__context__, arg_str, arg_width, arg_ch));
}
...
static vec4f __wrap_capitalize_32905318c4f7df49 ( Context * __context__ ) {
    char * const  arg_str = cast_aot_arg<char * const >::to(*__context__,__context__->abiArguments()[0]);
    return cast<char *>::from(capitalize_32905318c4f7df49(__context__, arg_str));
}
...
static AotFunction functions[] = {
    ...
    { 0xeb778d3f2018a9f, false, (void*)&_FuncbuiltinTickcloneTick3038771811667655495_7e81813bcc98f6c7, &__wrap__FuncbuiltinTickcloneTick3038771811667655495_7e81813bcc98f6c7 },
    ...
    { 0x1695b55be89cf382, false, (void*)&_FuncbuiltinTickemptyTick15399874715904164783_a2b1908396a6ed79, &__wrap__FuncbuiltinTickemptyTick15399874715904164783_a2b1908396a6ed79 },
    { 0x2cdd6a9efa3197df, false, (void*)&wide_53059f73cffda483, &__wrap_wide_53059f73cffda483 },
    { 0xccd8365cbbd36e5, true, (void*)&split_815bca29e5ea3727, &__wrap_split_815bca29e5ea3727 },
    { 0xcf5b314702f86ade, true, (void*)&split_by_chars_47006a727f2aaba8, &__wrap_split_by_chars_47006a727f2aaba8 },
    { 0xe4b31d1b9587e89d, false, (void*)&levenshtein_distance_549bdedc98dec005, &__wrap_levenshtein_distance_549bdedc98dec005 },
    { 0xa9bfae84c71b5ecf, false, (void*)&levenshtein_distance_fast_a9a12a715bbf1d10, &__wrap_levenshtein_distance_fast_a9a12a715bbf1d10 },
    { 0xb0e93bf106be3a0c, false, (void*)&replace_multiple_1da40d13c4a4caa0, &__wrap_replace_multiple_1da40d13c4a4caa0 },
    { 0xda659e15a701f676, false, (void*)&contains_b393616ecb73d32c, &__wrap_contains_b393616ecb73d32c },
    { 0xb2b482bf294c715d, false, (void*)&count_f1b1310311a77129, &__wrap_count_f1b1310311a77129 },
    { 0xeb477370bc6bda94, false, (void*)&last_index_of_68a66f257a1281ba, &__wrap_last_index_of_68a66f257a1281ba },
    { 0xb2ac38e067e6ff85, false, (void*)&last_index_of_d79904c391afb2d3, &__wrap_last_index_of_d79904c391afb2d3 },
    { 0x51d49cd6ac77c953, false, (void*)&pad_right_a3ec73a8713839a4, &__wrap_pad_right_a3ec73a8713839a4 },
    { 0x106ab6c95b28412d, false, (void*)&pad_left_efdec77e951364ac, &__wrap_pad_left_efdec77e951364ac },
    ...
    { 0xee113a2098bc7989, false, (void*)&capitalize_32905318c4f7df49, &__wrap_capitalize_32905318c4f7df49 },
