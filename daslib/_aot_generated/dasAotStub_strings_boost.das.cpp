...
static inline void _FuncbuiltinTickresizeTick4811697762258667383_14682004b38ad2a1 ( Context * __context__, TArray<char *> & __Arr_rename_at_68_0, int32_t __newSize_rename_at_68_1 );
static inline void _FuncbuiltinTickcloneTick3038771811667655495_4060192a3cb0948 ( Context * __context__, TArray<char *> & __a_rename_at_1113_2, TArray<char *> const  & __b_rename_at_1113_3 );
static inline TArray<char *> & _FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_354a9a0b57d554a0 ( Context * __context__, TArray<char *> & __a_rename_at_50_9 );
static inline void _FuncbuiltinTickfinalizeTick13836114024949725080_5be9a99f60cdfbba ( Context * __context__, TArray<TArray<int32_t>> & __a_rename_at_1215_10 );
static inline void _FuncbuiltinTickfinalizeTick13836114024949725080_c2c15811c6d720e8 ( Context * __context__, TArray<int32_t> & __a_rename_at_1215_12 );
static inline void _FuncbuiltinTickresizeTick4811697762258667383_c1a73db481e59a8b ( Context * __context__, TArray<TArray<int32_t>> & __Arr_rename_at_68_13, int32_t __newSize_rename_at_68_14 );
static inline void _FuncbuiltinTickresizeTick4811697762258667383_1bdb9995fa062a51 ( Context * __context__, TArray<int32_t> & __Arr_rename_at_68_15, int32_t __newSize_rename_at_68_16 );
static inline void _FuncbuiltinTickswapTick6899974565646937647_4b12db88e6e6aa18 ( Context * __context__, TArray<int32_t> & __a_rename_at_1813_17, TArray<int32_t> & __b_rename_at_1813_18 );
static inline bool _FuncbuiltinTickemptyTick15399874715904164783_17e819552d1fbeb4 ( Context * __context__, TArray<AutoTuple<char *,char *>> const  & __a_rename_at_585_20 );
static inline char * wide_53059f73cffda483 ( Context * __context__, char * const  __text_rename_at_12_21, int32_t __width_rename_at_12_22 );
static inline TArray<char *> split_e671885aa89ee032 ( Context * __context__, char * const  __text_rename_at_96_24, char * const  __delim_rename_at_96_25 );
static inline TArray<char *> split_by_chars_143571b759d8cb31 ( Context * __context__, char * const  __text_rename_at_108_28, char * const  __delim_rename_at_108_29 );
static inline int32_t levenshtein_distance_81cc63ff8762bd35 ( Context * __context__, char * const  __s_rename_at_133_32, char * const  __t_rename_at_133_33 );
static inline int32_t levenshtein_distance_fast_4be142fb1ec75f90 ( Context * __context__, char * const  __s_rename_at_161_42, char * const  __t_rename_at_161_43 );
static inline char * replace_multiple_d0cf6948c5333e25 ( Context * __context__, char * const  __source_rename_at_191_54, TArray<AutoTuple<char *,char *>> const  & __replaces_rename_at_191_55 );
...
static inline void _FuncbuiltinTickcloneTick3038771811667655495_4060192a3cb0948 ( Context * __context__, TArray<char *> &  __a_rename_at_1113_2, TArray<char *> const  &  __b_rename_at_1113_3 )
{
    int32_t __ln_rename_at_1114_4 = ((int32_t)builtin_array_size(__b_rename_at_1113_3));
    _FuncbuiltinTickresizeTick4811697762258667383_14682004b38ad2a1(__context__,das_arg<TArray<char *>>::pass(__a_rename_at_1113_2),__ln_rename_at_1114_4);
    if ( __ln_rename_at_1114_4 == 0 )
    {
        return ;
    } else {
        {
            ...
            // aV: string aka TT&
            das_iterator<TArray<char *>> __aV_iterator(__a_rename_at_1113_2);
            char * * __aV_rename_at_1124_7;
            __need_loop_1124 = __aV_iterator.first(__context__,(__aV_rename_at_1124_7)) && __need_loop_1124;
            // bV: string const&#
            das_iterator<TArray<char *> const > __bV_iterator(__b_rename_at_1113_3);
            char * const  * __bV_rename_at_1124_8;
            __need_loop_1124 = __bV_iterator.first(__context__,(__bV_rename_at_1124_8)) && __need_loop_1124;
            for ( ; __need_loop_1124 ; __need_loop_1124 = __aV_iterator.next(__context__,(__aV_rename_at_1124_7)) && __bV_iterator.next(__context__,(__bV_rename_at_1124_8)) )
            {
                das_copy((*__aV_rename_at_1124_7),((char * const )(builtin_string_clone((*__bV_rename_at_1124_8),__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL))))));
            }
            __aV_iterator.close(__context__,(__aV_rename_at_1124_7));
            __bV_iterator.close(__context__,(__bV_rename_at_1124_8));
        };
    };
}
...
{
    {
        ...
        // aV: array<int> aka TT&
        das_iterator<TArray<TArray<int32_t>>> __aV_iterator(__a_rename_at_1215_10);
        TArray<int32_t> * __aV_rename_at_1217_11;
        ...
        {
            _FuncbuiltinTickfinalizeTick13836114024949725080_c2c15811c6d720e8(__context__,das_arg<TArray<int32_t>>::pass((*__aV_rename_at_1217_11)));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1217_11));
    };
    builtin_array_free(das_arg<TArray<TArray<int32_t>>>::pass(__a_rename_at_1215_10),24,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}

static inline void _FuncbuiltinTickfinalizeTick13836114024949725080_c2c15811c6d720e8 ( Context * __context__, TArray<int32_t> &  __a_rename_at_1215_12 )
{
    builtin_array_free(das_arg<TArray<int32_t>>::pass(__a_rename_at_1215_12),4,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
static inline void _FuncbuiltinTickswapTick6899974565646937647_4b12db88e6e6aa18 ( Context * __context__, TArray<int32_t> &  __a_rename_at_1813_17, TArray<int32_t> &  __b_rename_at_1813_18 )
{
    TArray<int32_t> __t_rename_at_1815_19; das_zero(__t_rename_at_1815_19); das_move(__t_rename_at_1815_19, __a_rename_at_1813_17);
    das_move(__a_rename_at_1813_17,__b_rename_at_1813_18);
    das_move(__b_rename_at_1813_18,__t_rename_at_1815_19);
}
...
static inline TArray<char *> split_e671885aa89ee032 ( Context * __context__, char * const  __text_rename_at_96_24, char * const  __delim_rename_at_96_25 ) { das_stack_prologue __prologue(__context__,96,"split " DAS_FILE_LINE);
{
...
static inline TArray<char *> split_by_chars_143571b759d8cb31 ( Context * __context__, char * const  __text_rename_at_108_28, char * const  __delim_rename_at_108_29 ) { das_stack_prologue __prologue(__context__,96,"split_by_chars " DAS_FILE_LINE);
{
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x380b7455b0a2f9f5] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_Aot>(&_FuncbuiltinTickresizeTick4811697762258667383_14682004b38ad2a1);
    };
    aotLib[0x4dae975ff549d69b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_Aot>(&_FuncbuiltinTickcloneTick3038771811667655495_4060192a3cb0948);
    };
    aotLib[0x8ff205c681819963] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_Aot>(&_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_354a9a0b57d554a0);
    };
    aotLib[0x8cfab1c459867f92] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_Aot>(&_FuncbuiltinTickfinalizeTick13836114024949725080_5be9a99f60cdfbba);
    };
    aotLib[0x439426c0e62e2f81] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_Aot>(&_FuncbuiltinTickfinalizeTick13836114024949725080_c2c15811c6d720e8);
    };
    aotLib[0x31e785d0d32596a0] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_Aot>(&_FuncbuiltinTickresizeTick4811697762258667383_c1a73db481e59a8b);
    };
    aotLib[0xd5b298fc293f15ad] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_Aot>(&_FuncbuiltinTickresizeTick4811697762258667383_1bdb9995fa062a51);
    };
    aotLib[0x983ece9be972c6d9] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_Aot>(&_FuncbuiltinTickswapTick6899974565646937647_4b12db88e6e6aa18);
    };
    aotLib[0x93680ae9c38c532] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_Aot>(&_FuncbuiltinTickemptyTick15399874715904164783_17e819552d1fbeb4);
    };
    aotLib[0x2cdd6a9efa3197df] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_Aot>(&wide_53059f73cffda483);
    };
    aotLib[0x4d12a7ea6bd28d97] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_AotCMRES>(&split_e671885aa89ee032);
    };
    aotLib[0xb7f216ac51574988] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_AotCMRES>(&split_by_chars_143571b759d8cb31);
    };
    aotLib[0x38cd58da5e8d5634] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_Aot>(&levenshtein_distance_81cc63ff8762bd35);
    };
    aotLib[0x4c9205449631d7cb] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_Aot>(&levenshtein_distance_fast_4be142fb1ec75f90);
    };
    aotLib[0x80367ae3d8465b8f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeAotNode<SimNode_Aot>(&replace_multiple_d0cf6948c5333e25);
    };
