...
inline void _FuncbuiltinTickresizeTick4811697762258667383_cb951de01ca87a4e ( Context * __context__, TArray<uint8_t> & __Arr_rename_at_68_7, int32_t __newSize_rename_at_68_8 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_ee4a37bbcf70fe7d ( Context * __context__, TArray<das_source_formatter::TokenTemplate> & __a_rename_at_1215_9 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_3c986bfd8563d8b2 ( Context * __context__, TArray<das_source_formatter::Token> & __a_rename_at_1215_11 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_93cd492387de05e8 ( Context * __context__, TArray<das_source_formatter::FormatterToken> & __a_rename_at_1215_13 );
inline void _FuncbuiltinTickresizeTick4811697762258667383_fb7a66fc6a63821a ( Context * __context__, TArray<das_source_formatter::TokenTemplate> & __Arr_rename_at_68_15, int32_t __newSize_rename_at_68_16 );
inline bool _FuncbuiltinTickkey_existsTick16808803843923989214_5f8f761d5f23964f ( Context * __context__, TTable<char *,void> const  & __Tab_rename_at_1047_17, char * const  __at_rename_at_1047_18 );
inline void _FuncbuiltinTick_move_with_lockcheckTick3467971516570048129_7926e574de26b25d ( Context * __context__, TArray<uint8_t> & __a_rename_at_32_19, TArray<uint8_t> & __b_rename_at_32_20 );
inline int32_t _FuncbuiltinTicklengthTick18150397773952384912_6a9e877c15ce25b4 ( Context * __context__, TDim<char *,3> const  & __a_rename_at_581_21 );
...
inline int32_t _FuncbuiltinTickfind_indexTick6703785223819426183_7889f698fd41c370 ( Context * __context__, TDim<char *,22> const  & __arr_rename_at_1691_25, char * const  __key_rename_at_1691_26 );
inline TTable<char *,void> _FuncbuiltinTickto_table_moveTick3386430563931768014_c018a9675934bba9 ( Context * __context__, TDim<char *,8> const  & __a_rename_at_1450_28 );
...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_19613b645e94680e ( Context * __context__, TArray<uint8_t> & __a_rename_at_1215_33 );
inline int32_t _FuncbuiltinTickfind_indexTick6703785223819426183_eca839f98c5c2bc9 ( Context * __context__, TDim<char *,21> const  & __arr_rename_at_1691_34, char * const  __key_rename_at_1691_35 );
inline int32_t _FuncbuiltinTickfind_indexTick6703785223819426183_feb73043e4854e1f ( Context * __context__, TDim<char *,11> const  & __arr_rename_at_1691_37, char * const  __key_rename_at_1691_38 );
inline void _FuncbuiltinTickcloneTick3038771811667655495_11c19903beee414c ( Context * __context__, TArray<uint8_t> & __a_rename_at_1113_40, TArray<uint8_t> const  & __b_rename_at_1113_41 );
inline void _FuncbuiltinTickpushTick10769833213962245646_e919271fa2eab772 ( Context * __context__, TArray<das_source_formatter::Token> & __Arr_rename_at_181_43, das_source_formatter::Token & __value_rename_at_181_44 );
inline void _FuncbuiltinTickpushTick10769833213962245646_fc8141dc0153320a ( Context * __context__, TArray<das_source_formatter::FormatterToken> & __Arr_rename_at_181_45, das_source_formatter::FormatterToken & __value_rename_at_181_46 );
inline void _Funcdas_source_formatterTickremove_space_beforeTick16814636979153707331_497548c4fac9c297 ( Context * __context__, das_source_formatter::FormatterCtx & __ctx_rename_at_944_47, int32_t __i_rename_at_944_48 );
inline void _FuncbuiltinTickpushTick14133213201864676143_833f2ca565fa23fb ( Context * __context__, TArray<uint8_t> & __Arr_rename_at_165_49, uint8_t __value_rename_at_165_50 );
inline void _Funcdas_source_formatterTickadd_space_beforeTick12675954149209894053_cfe2c69de3466279 ( Context * __context__, das_source_formatter::FormatterCtx & __ctx_rename_at_936_51, int32_t __i_rename_at_936_52 );
inline int32_t _FuncbuiltinTickfind_indexTick6703785223819426183_a4c49c41e04684c4 ( Context * __context__, TDim<char *,3> const  & __arr_rename_at_1691_53, char * const  __key_rename_at_1691_54 );
inline void finalize_db456bcf8e957ca4 ( Context * __context__, das_source_formatter::FormatterCtx & ____this_rename_at_68_56 );
...
{
    {
        ...
        {
            finalize_470a2c87c10459f3(__context__,das_arg<das_source_formatter::TokenTemplate>::pass((*__aV_rename_at_1217_10)));
        }
...
{
    {
        ...
        {
            finalize_90b2200a89e5f7af(__context__,das_arg<das_source_formatter::Token>::pass((*__aV_rename_at_1217_12)));
        }
...
{
    {
        ...
        {
            finalize_8ce52f97d3e92f29(__context__,das_arg<das_source_formatter::FormatterToken>::pass((*__aV_rename_at_1217_14)));
        }
...
inline void _FuncbuiltinTickcloneTick3038771811667655495_11c19903beee414c ( Context * __context__, TArray<uint8_t> &  __a_rename_at_1113_40, TArray<uint8_t> const  &  __b_rename_at_1113_41 )
{
    ...
    _FuncbuiltinTickresizeTick4811697762258667383_cb951de01ca87a4e(__context__,das_arg<TArray<uint8_t>>::pass(__a_rename_at_1113_40),__ln_rename_at_1114_42);
...
inline void _Funcdas_source_formatterTickremove_space_beforeTick16814636979153707331_497548c4fac9c297 ( Context * __context__, das_source_formatter::FormatterCtx &  __ctx_rename_at_944_47, int32_t __i_rename_at_944_48 )
{
    if ( (__ctx_rename_at_944_47.tokens(__i_rename_at_944_48,__context__).dontFormat || __ctx_rename_at_944_47.tokens((__i_rename_at_944_48 - 1),__context__).dontFormat) || new_line_before_74a9e3638b00c26f(__context__,das_arg<das_source_formatter::FormatterCtx>::pass(__ctx_rename_at_944_47),__i_rename_at_944_48) )
    {
        return ;
    } else {
...
inline void _Funcdas_source_formatterTickadd_space_beforeTick12675954149209894053_cfe2c69de3466279 ( Context * __context__, das_source_formatter::FormatterCtx &  __ctx_rename_at_936_51, int32_t __i_rename_at_936_52 )
{
    if ( (__ctx_rename_at_936_51.tokens(__i_rename_at_936_52,__context__).dontFormat || __ctx_rename_at_936_51.tokens((__i_rename_at_936_52 - 1),__context__).dontFormat) || new_line_before_74a9e3638b00c26f(__context__,das_arg<das_source_formatter::FormatterCtx>::pass(__ctx_rename_at_936_51),__i_rename_at_936_52) )
    {
        return ;
    } else {
...
inline void finalize_db456bcf8e957ca4 ( Context * __context__, das_source_formatter::FormatterCtx &  ____this_rename_at_68_56 )
{
    _FuncbuiltinTickfinalizeTick13836114024949725080_ee4a37bbcf70fe7d(__context__,das_arg<TArray<das_source_formatter::TokenTemplate>>::pass(____this_rename_at_68_56.tokenTemplates));
    _FuncbuiltinTickfinalizeTick13836114024949725080_3c986bfd8563d8b2(__context__,das_arg<TArray<das_source_formatter::Token>>::pass(____this_rename_at_68_56.tokens));
    _FuncbuiltinTickfinalizeTick13836114024949725080_93cd492387de05e8(__context__,das_arg<TArray<das_source_formatter::FormatterToken>>::pass(____this_rename_at_68_56.formatterTokens));
    _FuncbuiltinTickfinalizeTick13836114024949725080_19613b645e94680e(__context__,das_arg<TArray<uint8_t>>::pass(____this_rename_at_68_56.data));
