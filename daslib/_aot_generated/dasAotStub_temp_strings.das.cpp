...
inline void _FuncbuiltinTickpushTick10769833213962245646_fb0ee1fbb9230f7b ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_0, ast::AstFunctionAnnotation * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_2773376b7ffaf9ac ( Context * __context__, temp_strings::TempStringMacro const  & __cl_rename_at_116_2 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_2ee133f42b9ec91d ( Context * __context__, char * const  __name_rename_at_631_3, temp_strings::TempStringMacro * __someClassPtr_rename_at_631_4 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_26699e4ed266f301 ( Context * __context__, char * const  __name_rename_at_273_6, char * const  __tag_rename_at_273_7, temp_strings::TempStringMacro * __classPtr_rename_at_273_8 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_2ee133f42b9ec91d ( Context * __context__, char * const  __name_rename_at_631_3, temp_strings::TempStringMacro * __someClassPtr_rename_at_631_4 )
{
    _FuncbuiltinTickpushTick10769833213962245646_fb0ee1fbb9230f7b(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_631_4));
    StructInfo const  * __classInfo_rename_at_634_5 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_2773376b7ffaf9ac(__context__,das_arg<temp_strings::TempStringMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_631_4))));
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_26699e4ed266f301 ( Context * __context__, char * const  __name_rename_at_273_6, char * const  __tag_rename_at_273_7, temp_strings::TempStringMacro * __classPtr_rename_at_273_8 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_9; das_zero(__ann_rename_at_274_9); das_move(__ann_rename_at_274_9, _FuncastTickmake_function_annotationTick3074191368936885601_2ee133f42b9ec91d(__context__,__name_rename_at_273_6,__classPtr_rename_at_273_8));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xae7ce8c0b7749d26] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_fb0ee1fbb9230f7b>>();
    };
    aotLib[0x9034153643f478a9] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_2773376b7ffaf9ac>>();
    };
    aotLib[0x48817d52c8267927] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_function_annotationTick3074191368936885601_2ee133f42b9ec91d>>();
    };
    aotLib[0xe00534a213e28f75] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_26699e4ed266f301>>();
    };
