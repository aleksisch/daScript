...
inline void _FuncbuiltinTickpushTick10769833213962245646_7deb436aba2b1f06 ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_0, ast::AstFunctionAnnotation * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_9b833a4fc3d5365a ( Context * __context__, defer::DeferMacro const  & __cl_rename_at_116_2 );
inline void _FuncbuiltinTickpushTick10769833213962245646_5b7b59aeeadc41a9 ( Context * __context__, TArray<ast::AstCallMacro *> & __Arr_rename_at_181_3, ast::AstCallMacro * __value_rename_at_181_4 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_f5eceda02e64c6a2 ( Context * __context__, defer::DeferDeleteMacro const  & __cl_rename_at_116_5 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_2726161c9ccd9448 ( Context * __context__, char * const  __name_rename_at_631_6, defer::DeferMacro * __someClassPtr_rename_at_631_7 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_4fa84c245d317a8f ( Context * __context__, char * const  __name_rename_at_273_9, char * const  __tag_rename_at_273_10, defer::DeferMacro * __classPtr_rename_at_273_11 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_2726161c9ccd9448 ( Context * __context__, char * const  __name_rename_at_631_6, defer::DeferMacro * __someClassPtr_rename_at_631_7 )
{
    _FuncbuiltinTickpushTick10769833213962245646_7deb436aba2b1f06(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_631_7));
    StructInfo const  * __classInfo_rename_at_634_8 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_9b833a4fc3d5365a(__context__,das_arg<defer::DeferMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_631_7))));
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_4fa84c245d317a8f ( Context * __context__, char * const  __name_rename_at_273_9, char * const  __tag_rename_at_273_10, defer::DeferMacro * __classPtr_rename_at_273_11 )
{
    smart_ptr_raw<FunctionAnnotation> __ann_rename_at_274_12; memset((void*)&__ann_rename_at_274_12,0,sizeof(__ann_rename_at_274_12));
    ...
    /* end finally */ });
    __ann_rename_at_274_12; das_zero(__ann_rename_at_274_12); das_move(__ann_rename_at_274_12, _FuncastTickmake_function_annotationTick3074191368936885601_2726161c9ccd9448(__context__,__name_rename_at_273_9,__classPtr_rename_at_273_11));
    das_invoke_function<void>::invoke<char * const ,smart_ptr_raw<FunctionAnnotation>>(__context__,nullptr,Func(__context__->fnByMangledName(/*@ast_boost::apply_tag_annotation Cs Y<FunctionAnnotationPtr>1<H<ast::FunctionAnnotation>>?M*/ 0x7678364e276db9c2)),__tag_rename_at_273_10,__ann_rename_at_274_12);
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xa9c4ede660a997d1] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_7deb436aba2b1f06>>();
    };
    aotLib[0x36e24ac8712be2f4] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_9b833a4fc3d5365a>>();
    };
    aotLib[0x39c92125c126435] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_5b7b59aeeadc41a9>>();
    };
    aotLib[0xbe31e55a3b882fa6] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_f5eceda02e64c6a2>>();
    };
    aotLib[0xe18ada1c5543b14c] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_function_annotationTick3074191368936885601_2726161c9ccd9448>>();
    };
    aotLib[0x148561e28aecfc2e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_4fa84c245d317a8f>>();
    };
