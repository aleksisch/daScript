...
inline void _FuncbuiltinTickpushTick10769833213962245646_777c58f0a08aef24 ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_0, ast::AstFunctionAnnotation * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_8db96aacbb318db ( Context * __context__, bitfield_trait::EachBitfieldMacro const  & __cl_rename_at_116_2 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_9f7b966af5904750 ( Context * __context__, char * const  __name_rename_at_631_7, bitfield_trait::EachBitfieldMacro * __someClassPtr_rename_at_631_8 );
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_c62f16536efff787 ( Context * __context__, char * const  __value_rename_at_882_10 );
...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_7392552d7e54265c ( Context * __context__, TArray<smart_ptr_raw<Expression>> & __a_rename_at_1215_13 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_1caade7e8fa43c1f ( Context * __context__, char * const  __name_rename_at_273_15, char * const  __tag_rename_at_273_16, bitfield_trait::EachBitfieldMacro * __classPtr_rename_at_273_17 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_9f7b966af5904750 ( Context * __context__, char * const  __name_rename_at_631_7, bitfield_trait::EachBitfieldMacro * __someClassPtr_rename_at_631_8 )
{
    _FuncbuiltinTickpushTick10769833213962245646_777c58f0a08aef24(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_631_8));
    StructInfo const  * __classInfo_rename_at_634_9 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_8db96aacbb318db(__context__,das_arg<bitfield_trait::EachBitfieldMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_631_8))));
...
inline smart_ptr_raw<Expression> _Funcast_boostTickconvert_to_expressionTick11707039267614988023_c62f16536efff787 ( Context * __context__, char * const  __value_rename_at_882_10 )
{
    ...
    return /* <- */ das_auto_cast_move<smart_ptr_raw<Expression>>::cast(das_invoke_function<smart_ptr_raw<Expression>>::invoke<char * const ,LineInfo const  &>(__context__,nullptr,Func(__context__->fnByMangledName(/*@bitfield_trait::ast_boost`convert_to_expression`16483834305137942954 C=Xs CH<rtti::LineInfo>*/ 0x2f1974bcbc93080)),__value_rename_at_882_10,das_arg<LineInfo>::pass((_temp_make_local_883_43_0 = (/*c-tor*/ LineInfo(/*end-c-tor*/))))));
}
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_1caade7e8fa43c1f ( Context * __context__, char * const  __name_rename_at_273_15, char * const  __tag_rename_at_273_16, bitfield_trait::EachBitfieldMacro * __classPtr_rename_at_273_17 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_18; das_zero(__ann_rename_at_274_18); das_move(__ann_rename_at_274_18, _FuncastTickmake_function_annotationTick3074191368936885601_9f7b966af5904750(__context__,__name_rename_at_273_15,__classPtr_rename_at_273_17));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xb77910f8f739f6ea] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_777c58f0a08aef24>>();
    };
    aotLib[0xa2869fe1e0d6c91a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_8db96aacbb318db>>();
    };
    aotLib[0xc03e6b4febebb54] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_function_annotationTick3074191368936885601_9f7b966af5904750>>();
    };
    aotLib[0x32c02fa6a974931b] = +[](Context & ctx) -> SimNode* {
    ...
    aotLib[0xef89e10ff412e9cc] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_1caade7e8fa43c1f>>();
    };
    // [[ init script ]]
