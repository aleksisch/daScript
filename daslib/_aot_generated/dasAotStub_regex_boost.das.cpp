...
inline void finalize_a7f7bd2b9b87e4f3 ( Context * __context__, AutoTuple<range,char *> & ____this_rename_at_1219_0 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_27fd8daed3303e9b ( Context * __context__, TArray<regex::ReNode *> & __a_rename_at_1215_1 );
inline void _FuncbuiltinTickpushTick10769833213962245646_7a68ea24a5aa274d ( Context * __context__, TArray<ast::AstReaderMacro *> & __Arr_rename_at_181_3, ast::AstReaderMacro * __value_rename_at_181_4 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_71748d7d0db3ed06 ( Context * __context__, regex_boost::RegexReader const  & __cl_rename_at_116_5 );
inline void finalize_278f1f20d31388fe ( Context * __context__, regex::ReNode & ____this_rename_at_29_6 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_26a208a8146631fb ( Context * __context__, TArray<AutoTuple<range,char *>> & __a_rename_at_1215_7 );
...
inline void finalize_a7f7bd2b9b87e4f3 ( Context * __context__, AutoTuple<range,char *> &  ____this_rename_at_1219_0 )
{
    memset((void*)&(____this_rename_at_1219_0), 0, TypeSize<AutoTuple<range,char *>>::size);
}
...
{
    {
        ...
        das_iterator<TArray<regex::ReNode *>> __aV_iterator(__a_rename_at_1215_1);
        regex::ReNode * * __aV_rename_at_1217_2;
        __need_loop_1217 = __aV_iterator.first(__context__,(__aV_rename_at_1217_2)) && __need_loop_1217;
        for ( ; __need_loop_1217 ; __need_loop_1217 = __aV_iterator.next(__context__,(__aV_rename_at_1217_2)) )
        {
            finalize_b7627f8bd23394ca(__context__,(*__aV_rename_at_1217_2));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1217_2));
    };
    builtin_array_free(das_arg<TArray<regex::ReNode *>>::pass(__a_rename_at_1215_1),8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
inline void finalize_278f1f20d31388fe ( Context * __context__, regex::ReNode &  ____this_rename_at_29_6 )
{
    _FuncbuiltinTickfinalizeTick13836114024949725080_27fd8daed3303e9b(__context__,das_arg<TArray<regex::ReNode *>>::pass(____this_rename_at_29_6.all));
    finalize_b7627f8bd23394ca(__context__,____this_rename_at_29_6.left);
    finalize_b7627f8bd23394ca(__context__,____this_rename_at_29_6.right);
    finalize_b7627f8bd23394ca(__context__,____this_rename_at_29_6.subexpr);
...
{
    {
        ...
        das_iterator<TArray<AutoTuple<range,char *>>> __aV_iterator(__a_rename_at_1215_7);
        AutoTuple<range,char *> * __aV_rename_at_1217_8;
        ...
        {
            finalize_a7f7bd2b9b87e4f3(__context__,das_arg<AutoTuple<range,char *>>::pass((*__aV_rename_at_1217_8)));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1217_8));
    };
    builtin_array_free(das_arg<TArray<AutoTuple<range,char *>>>::pass(__a_rename_at_1215_7),16,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
inline void finalize_b7627f8bd23394ca ( Context * __context__, regex::ReNode * & ____this_rename_at_50_9 )
{
    ...
    {
        finalize_278f1f20d31388fe(__context__,das_arg<regex::ReNode>::pass(das_deref(__context__,____this_rename_at_50_9)));
...
inline void finalize_cb15fd59be01413f ( Context * __context__, regex::Regex &  ____this_rename_at_48_10 )
{
    finalize_b7627f8bd23394ca(__context__,____this_rename_at_48_10.root);
    _FuncbuiltinTickfinalizeTick13836114024949725080_26a208a8146631fb(__context__,das_arg<TArray<AutoTuple<range,char *>>>::pass(____this_rename_at_48_10.groups));
    memset((void*)&(____this_rename_at_48_10), 0, TypeSize<regex::Regex>::size);
}

static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x6ebaf9052285ff70] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&finalize_a7f7bd2b9b87e4f3>>();
    };
    aotLib[0xb146b0cc2095449e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickfinalizeTick13836114024949725080_27fd8daed3303e9b>>();
    };
    aotLib[0x1057464f9d95fe31] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_7a68ea24a5aa274d>>();
    };
    aotLib[0x29bb677653077f2b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_71748d7d0db3ed06>>();
    };
    aotLib[0x2eb30a4e668b0ce] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&finalize_278f1f20d31388fe>>();
    };
    aotLib[0x9806755b1dc4b45e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickfinalizeTick13836114024949725080_26a208a8146631fb>>();
    };
    aotLib[0xc2c1faec7223159e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&finalize_b7627f8bd23394ca>>();
    };
    aotLib[0x292e1922ffda5e19] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&finalize_cb15fd59be01413f>>();
    };
