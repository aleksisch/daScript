...
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_3e0b25f053f10679 ( Context * __context__, regex_boost::RegexReader const  & __cl_rename_at_116_5 );
...
inline void finalize_cd5820a25c69c080 ( Context * __context__, regex::ReNode * & ____this_rename_at_80_9 );
...
{
    {
        ...
        das_iterator<TArray<regex::ReNode *>> __aV_iterator(__a_rename_at_1336_1);
        regex::ReNode * * __aV_rename_at_1338_2;
        ...
        {
            finalize_cd5820a25c69c080(__context__,(*__aV_rename_at_1338_2));
        }
...
inline void finalize_e83b23d3fbb7275a ( Context * __context__, regex::ReNode &  ____this_rename_at_56_6 )
{
    ...
    finalize_cd5820a25c69c080(__context__,____this_rename_at_56_6.left);
    finalize_cd5820a25c69c080(__context__,____this_rename_at_56_6.right);
    finalize_cd5820a25c69c080(__context__,____this_rename_at_56_6.subexpr);
...
inline void finalize_abce4dc887b85003 ( Context * __context__, regex::Regex &  ____this_rename_at_78_10 )
{
    finalize_cd5820a25c69c080(__context__,____this_rename_at_78_10.root);
...
static vec4f __wrap__FuncrttiTickclass_infoTick15801393167907430156_3e0b25f053f10679 ( Context * __context__ ) {
    ...
    return cast<StructInfo const  *>::from(_FuncrttiTickclass_infoTick15801393167907430156_3e0b25f053f10679(__context__, arg_cl));
}
...
static vec4f __wrap_finalize_cd5820a25c69c080 ( Context * __context__ ) {
    regex::ReNode * & arg___this = cast_aot_arg<regex::ReNode * &>::to(*__context__,__context__->abiArguments()[0]);
    finalize_cd5820a25c69c080(__context__, arg___this);
    return v_zero();
}
...
static AotFunction functions[] = {
    ...
    { 0x22ff886e21ca7851, false, (void*)&_FuncbuiltinTickfinalizeTick13836114024949725080_5461a1a6b287432c, &__wrap__FuncbuiltinTickfinalizeTick13836114024949725080_5461a1a6b287432c },
    ...
    { 0x9b2f0089de184ef4, false, (void*)&_FuncrttiTickclass_infoTick15801393167907430156_3e0b25f053f10679, &__wrap__FuncrttiTickclass_infoTick15801393167907430156_3e0b25f053f10679 },
    { 0x5911e62f63121d5d, false, (void*)&finalize_e83b23d3fbb7275a, &__wrap_finalize_e83b23d3fbb7275a },
    ...
    { 0x344bb251fa726d5f, false, (void*)&finalize_cd5820a25c69c080, &__wrap_finalize_cd5820a25c69c080 },
    { 0xff703bb9d0d9b0f, false, (void*)&finalize_abce4dc887b85003, &__wrap_finalize_abce4dc887b85003 },
};
#pragma optimize("", on)
