...
inline uint32_t _FuncrandomTickrandom_uintTick15141358123050100739_ace3444e720a3102 ( Context * __context__, int4 & __seed_rename_at_52_0 );
...
inline int4 _FuncrandomTickrandom_seedTick15287272150245073176_dd30826a0cea51ed ( Context * __context__, int32_t __seed_rename_at_23_5 );
inline bool _Func_lambda_random_119_1Tickfunction_66e92d85059eeb09 ( Context * __context__, random::_lambda_random_119_1 & ____this_rename_at_119_6, uint32_t & ___yield_119_rename_at_119_7 );
...
inline Sequence DAS_COMMENT((uint32_t)) each_random_uint_a86630d5a7bba8d ( Context * __context__, int32_t __rnd_seed_rename_at_117_9 );
...
inline bool _Func_lambda_random_119_1Tickfunction_66e92d85059eeb09 ( Context * __context__, random::_lambda_random_119_1 &  ____this_rename_at_119_6, uint32_t & ___yield_119_rename_at_119_7 )
{
    ...
    label_0:;;
    das_copy(____this_rename_at_119_6.seed,_FuncrandomTickrandom_seedTick15287272150245073176_dd30826a0cea51ed(__context__,____this_rename_at_119_6.rnd_seed));
    label_1:;;
    das_copy(___yield_119_rename_at_119_7,_FuncrandomTickrandom_uintTick15141358123050100739_ace3444e720a3102(__context__,____this_rename_at_119_6.seed));
...
static vec4f __wrap__Func_lambda_random_119_1Tickfunction_66e92d85059eeb09 ( Context * __context__ ) {
    random::_lambda_random_119_1 &  arg___this = cast_aot_arg<random::_lambda_random_119_1 & >::to(*__context__,__context__->abiArguments()[0]);
    uint32_t & arg__yield_119 = cast_aot_arg<uint32_t &>::to(*__context__,__context__->abiArguments()[1]);
    return cast<bool>::from(_Func_lambda_random_119_1Tickfunction_66e92d85059eeb09(__context__, arg___this, arg__yield_119));
}
...
static vec4f __wrap_each_random_uint_a86630d5a7bba8d ( Context * __context__ ) {
    int32_t arg_rnd_seed = cast_aot_arg<int32_t>::to(*__context__,__context__->abiArguments()[0]);
    *((Sequence DAS_COMMENT((uint32_t)) *) __context__->abiCMRES) = each_random_uint_a86630d5a7bba8d(__context__, arg_rnd_seed);
    return v_zero();
}
...
static AotFunction functions[] = {
    ...
    { 0x4605116ae827a638, false, (void*)&_Func_lambda_random_119_1Tickfunction_66e92d85059eeb09, &__wrap__Func_lambda_random_119_1Tickfunction_66e92d85059eeb09 },
    ...
    { 0x5edf99ff5f85c407, true, (void*)&each_random_uint_a86630d5a7bba8d, &__wrap_each_random_uint_a86630d5a7bba8d },
};
#pragma optimize("", on)
