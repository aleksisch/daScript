...
inline void _FuncbuiltinTickpushTick10769833213962245646_9bb99a0f36776a31 ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_2, ast::AstFunctionAnnotation * __value_rename_at_181_3 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_5950a0d3df4d154a ( Context * __context__, assert_once::AssertOnceMacro const  & __cl_rename_at_116_4 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_e6fdfb369293ec1f ( Context * __context__, char * const  __name_rename_at_631_7, assert_once::AssertOnceMacro * __someClassPtr_rename_at_631_8 );
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_ae5d8357532f3e1e ( Context * __context__, smart_ptr_raw<Expression> const  __src_rename_at_1777_10 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_992b3e47d2860cde ( Context * __context__, char * const  __name_rename_at_273_12, char * const  __tag_rename_at_273_13, assert_once::AssertOnceMacro * __classPtr_rename_at_273_14 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_e6fdfb369293ec1f ( Context * __context__, char * const  __name_rename_at_631_7, assert_once::AssertOnceMacro * __someClassPtr_rename_at_631_8 )
{
    _FuncbuiltinTickpushTick10769833213962245646_9bb99a0f36776a31(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_631_8));
    StructInfo const  * __classInfo_rename_at_634_9 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_5950a0d3df4d154a(__context__,das_arg<assert_once::AssertOnceMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_631_8))));
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_ae5d8357532f3e1e ( Context * __context__, smart_ptr_raw<Expression> const  __src_rename_at_1777_10 )
{
    smart_ptr_raw<Expression> __dst_rename_at_1779_11; das_zero(__dst_rename_at_1779_11); das_move(__dst_rename_at_1779_11, _FuncbuiltinTickclone_to_moveTick2007252383599261567_beedcbcfca1e475b(__context__,das_cast<smart_ptr_raw<Expression>>::cast(__src_rename_at_1777_10)));
    return /* <- */ das_auto_cast_move<smart_ptr_raw<Expression>>::cast(__dst_rename_at_1779_11);
}

inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_992b3e47d2860cde ( Context * __context__, char * const  __name_rename_at_273_12, char * const  __tag_rename_at_273_13, assert_once::AssertOnceMacro * __classPtr_rename_at_273_14 )
{
    smart_ptr_raw<FunctionAnnotation> __ann_rename_at_274_15; memset((void*)&__ann_rename_at_274_15,0,sizeof(__ann_rename_at_274_15));
    ...
    /* end finally */ });
    __ann_rename_at_274_15; das_zero(__ann_rename_at_274_15); das_move(__ann_rename_at_274_15, _FuncastTickmake_function_annotationTick3074191368936885601_e6fdfb369293ec1f(__context__,__name_rename_at_273_12,__classPtr_rename_at_273_14));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xe6a572b74fa17bf7] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_9bb99a0f36776a31>>();
    };
    aotLib[0xaaaeca34212c3e36] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_5950a0d3df4d154a>>();
    };
    ...
    aotLib[0x52a0592c6fd0fe2e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_function_annotationTick3074191368936885601_e6fdfb369293ec1f>>();
    };
    ...
    aotLib[0x10175a18e5cf2af8] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_992b3e47d2860cde>>();
    };
