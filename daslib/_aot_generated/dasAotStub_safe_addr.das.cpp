...
inline void _FuncbuiltinTickpushTick10769833213962245646_a1e7f78ca7753fb8 ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_0, ast::AstFunctionAnnotation * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_1a142e99d779193 ( Context * __context__, safe_addr::SafeAddrMacro const  & __cl_rename_at_116_2 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_d75c32c80fbf20f5 ( Context * __context__, safe_addr::SharedAddrMacro const  & __cl_rename_at_116_3 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_e33fbf6b6ac92113 ( Context * __context__, safe_addr::TempValueMacro const  & __cl_rename_at_116_4 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_f1abec5c2df0eaad ( Context * __context__, char * const  __name_rename_at_631_5, safe_addr::SafeAddrMacro * __someClassPtr_rename_at_631_6 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_a42275554cfc1aa1 ( Context * __context__, char * const  __name_rename_at_631_8, safe_addr::SharedAddrMacro * __someClassPtr_rename_at_631_9 );
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_f200b9215857248a ( Context * __context__, char * const  __name_rename_at_631_11, safe_addr::TempValueMacro * __someClassPtr_rename_at_631_12 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_96ec5d918e402a01 ( Context * __context__, char * const  __name_rename_at_273_14, char * const  __tag_rename_at_273_15, safe_addr::SafeAddrMacro * __classPtr_rename_at_273_16 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_69f21641295bdddb ( Context * __context__, char * const  __name_rename_at_273_18, char * const  __tag_rename_at_273_19, safe_addr::SharedAddrMacro * __classPtr_rename_at_273_20 );
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_6363c3388651d873 ( Context * __context__, char * const  __name_rename_at_273_22, char * const  __tag_rename_at_273_23, safe_addr::TempValueMacro * __classPtr_rename_at_273_24 );
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_f1abec5c2df0eaad ( Context * __context__, char * const  __name_rename_at_631_5, safe_addr::SafeAddrMacro * __someClassPtr_rename_at_631_6 )
{
    _FuncbuiltinTickpushTick10769833213962245646_a1e7f78ca7753fb8(__context__,das_arg<TArray<ast::AstFunctionAnnotation *>>::pass(das_global<TArray<ast::AstFunctionAnnotation *>,0x70a17c19e372bb43>(__context__) /*gc_root_AstFunctionAnnotation*/),das_reinterpret<ast::AstFunctionAnnotation *>::pass(__someClassPtr_rename_at_631_6));
    StructInfo const  * __classInfo_rename_at_634_7 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_1a142e99d779193(__context__,das_arg<safe_addr::SafeAddrMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_631_6))));
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_a42275554cfc1aa1 ( Context * __context__, char * const  __name_rename_at_631_8, safe_addr::SharedAddrMacro * __someClassPtr_rename_at_631_9 )
{
    ...
    StructInfo const  * __classInfo_rename_at_634_10 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_d75c32c80fbf20f5(__context__,das_arg<safe_addr::SharedAddrMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_631_9))));
...
inline smart_ptr_raw<FunctionAnnotation> _FuncastTickmake_function_annotationTick3074191368936885601_f200b9215857248a ( Context * __context__, char * const  __name_rename_at_631_11, safe_addr::TempValueMacro * __someClassPtr_rename_at_631_12 )
{
    ...
    StructInfo const  * __classInfo_rename_at_634_13 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_e33fbf6b6ac92113(__context__,das_arg<safe_addr::TempValueMacro>::pass(das_deref(__context__,__someClassPtr_rename_at_631_12))));
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_96ec5d918e402a01 ( Context * __context__, char * const  __name_rename_at_273_14, char * const  __tag_rename_at_273_15, safe_addr::SafeAddrMacro * __classPtr_rename_at_273_16 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_17; das_zero(__ann_rename_at_274_17); das_move(__ann_rename_at_274_17, _FuncastTickmake_function_annotationTick3074191368936885601_f1abec5c2df0eaad(__context__,__name_rename_at_273_14,__classPtr_rename_at_273_16));
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_69f21641295bdddb ( Context * __context__, char * const  __name_rename_at_273_18, char * const  __tag_rename_at_273_19, safe_addr::SharedAddrMacro * __classPtr_rename_at_273_20 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_21; das_zero(__ann_rename_at_274_21); das_move(__ann_rename_at_274_21, _FuncastTickmake_function_annotationTick3074191368936885601_a42275554cfc1aa1(__context__,__name_rename_at_273_18,__classPtr_rename_at_273_20));
...
inline void _Funcast_boostTicksetup_tag_annotationTick4095297895764883997_6363c3388651d873 ( Context * __context__, char * const  __name_rename_at_273_22, char * const  __tag_rename_at_273_23, safe_addr::TempValueMacro * __classPtr_rename_at_273_24 )
{
    ...
    /* end finally */ });
    __ann_rename_at_274_25; das_zero(__ann_rename_at_274_25); das_move(__ann_rename_at_274_25, _FuncastTickmake_function_annotationTick3074191368936885601_f200b9215857248a(__context__,__name_rename_at_273_22,__classPtr_rename_at_273_24));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x55ddb8364ee67d60] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_a1e7f78ca7753fb8>>();
    };
    aotLib[0x5f329c6a9e8e492b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_1a142e99d779193>>();
    };
    aotLib[0x9b410ab27e22f4d] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_d75c32c80fbf20f5>>();
    };
    aotLib[0xe1ae83c7ed76c392] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_e33fbf6b6ac92113>>();
    };
    aotLib[0x7808f297c6df6501] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_function_annotationTick3074191368936885601_f1abec5c2df0eaad>>();
    };
    aotLib[0x94dffd18c33eeedb] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_function_annotationTick3074191368936885601_a42275554cfc1aa1>>();
    };
    aotLib[0x109decccd875c918] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_function_annotationTick3074191368936885601_f200b9215857248a>>();
    };
    aotLib[0xfa56937b835a8b1c] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_96ec5d918e402a01>>();
    };
    aotLib[0x6963a2842a4d53da] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_69f21641295bdddb>>();
    };
    aotLib[0xa193e20febebb6f3] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_Funcast_boostTicksetup_tag_annotationTick4095297895764883997_6363c3388651d873>>();
    };
