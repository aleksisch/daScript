...
inline void _FuncbuiltinTickresizeTick4811697762258667383_235acebda28335df ( Context * __context__, TArray<uint8_t> & __Arr_rename_at_68_0, int32_t __newSize_rename_at_68_1 );
inline TArray<uint8_t> _FuncbuiltinTickclone_to_moveTick2007252383599261567_359bffb73f84303b ( Context * __context__, TArray<uint8_t> const  & __clone_src_rename_at_1089_2 );
inline void _FuncbuiltinTickcloneTick3038771811667655495_5d7fb39f4a94b6 ( Context * __context__, TArray<uint8_t> & __a_rename_at_1113_4, TArray<uint8_t> const  & __b_rename_at_1113_5 );
inline TArray<uint8_t> & _FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_b13cf2a57c7f809e ( Context * __context__, TArray<uint8_t> & __a_rename_at_50_7 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_cf8693e01f654e23 ( Context * __context__, TArray<uint8_t> & __a_rename_at_1215_8 );
...
inline void _FuncarchiveTickserialize_rawTick346513482259279339_6d2c9c6481493712 ( Context * __context__, archive::Archive & __arch_rename_at_90_11, float3x3 & __value_rename_at_90_12 );
inline void _FuncarchiveTickserialize_rawTick346513482259279339_bcb0a9e6e55f852c ( Context * __context__, archive::Archive & __arch_rename_at_90_13, float3x4 & __value_rename_at_90_14 );
inline void _FuncarchiveTickserialize_rawTick346513482259279339_a7e01b5704f8f9b5 ( Context * __context__, archive::Archive & __arch_rename_at_90_15, float4x4 & __value_rename_at_90_16 );
...
inline void serialize_3c1b8514c303b65d ( Context * __context__, archive::Archive & __arch_rename_at_133_47, float3x3 & __value_rename_at_133_48 );
inline void serialize_235622b057295444 ( Context * __context__, archive::Archive & __arch_rename_at_137_49, float3x4 & __value_rename_at_137_50 );
inline void serialize_a9fbea6743dc74d3 ( Context * __context__, archive::Archive & __arch_rename_at_141_51, float4x4 & __value_rename_at_141_52 );
...
inline TArray<uint8_t> _FuncbuiltinTickclone_to_moveTick2007252383599261567_359bffb73f84303b ( Context * __context__, TArray<uint8_t> const  &  __clone_src_rename_at_1089_2 )
{
    ...
    _FuncbuiltinTickcloneTick3038771811667655495_5d7fb39f4a94b6(__context__,das_arg<TArray<uint8_t>>::pass(__clone_dest_rename_at_1091_3),__clone_src_rename_at_1089_2);
...
inline void _FuncbuiltinTickcloneTick3038771811667655495_5d7fb39f4a94b6 ( Context * __context__, TArray<uint8_t> &  __a_rename_at_1113_4, TArray<uint8_t> const  &  __b_rename_at_1113_5 )
{
    ...
    _FuncbuiltinTickresizeTick4811697762258667383_235acebda28335df(__context__,das_arg<TArray<uint8_t>>::pass(__a_rename_at_1113_4),__ln_rename_at_1114_6);
...
inline void serialize_3c1b8514c303b65d ( Context * __context__, archive::Archive &  __arch_rename_at_133_47, float3x3 &  __value_rename_at_133_48 )
{
    _FuncarchiveTickserialize_rawTick346513482259279339_6d2c9c6481493712(__context__,das_arg<archive::Archive>::pass(__arch_rename_at_133_47),das_arg<float3x3>::pass(__value_rename_at_133_48));
}

inline void serialize_235622b057295444 ( Context * __context__, archive::Archive &  __arch_rename_at_137_49, float3x4 &  __value_rename_at_137_50 )
{
    _FuncarchiveTickserialize_rawTick346513482259279339_bcb0a9e6e55f852c(__context__,das_arg<archive::Archive>::pass(__arch_rename_at_137_49),das_arg<float3x4>::pass(__value_rename_at_137_50));
}

inline void serialize_a9fbea6743dc74d3 ( Context * __context__, archive::Archive &  __arch_rename_at_141_51, float4x4 &  __value_rename_at_141_52 )
{
    _FuncarchiveTickserialize_rawTick346513482259279339_a7e01b5704f8f9b5(__context__,das_arg<archive::Archive>::pass(__arch_rename_at_141_51),das_arg<float4x4>::pass(__value_rename_at_141_52));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x893f5e51750cd788] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncarchiveTickserialize_rawTick346513482259279339_6d2c9c6481493712>>();
    };
    aotLib[0xe670cd66da19aae9] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncarchiveTickserialize_rawTick346513482259279339_bcb0a9e6e55f852c>>();
    };
    aotLib[0x4a067f9d0415cd4a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncarchiveTickserialize_rawTick346513482259279339_a7e01b5704f8f9b5>>();
    };
    ...
    aotLib[0x47f4eb09d8f0ac96] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&serialize_3c1b8514c303b65d>>();
    };
    aotLib[0xb6b613947d960f87] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&serialize_235622b057295444>>();
    };
    aotLib[0x8db96a4ee5616da1] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&serialize_a9fbea6743dc74d3>>();
    };
