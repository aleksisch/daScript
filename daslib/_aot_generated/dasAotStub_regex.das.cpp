...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_4a49cd9427735830 ( Context * __context__, TArray<regex::ReNode *> & __a_rename_at_1215_2 );
...
inline TArray<regex::ReNode *> _FuncbuiltinTickto_array_moveTick3185538323411982277_4c5483eb7641701a ( Context * __context__, TDim<regex::ReNode *,2> & __a_rename_at_1375_13 );
...
inline bool _FuncbuiltinTicknextTick17450348357676149856_5eaabf5f150eca27 ( Context * __context__, Sequence DAS_COMMENT((uint32_t)) & __it_rename_at_1256_17, uint32_t & __value_rename_at_1256_18 );
...
{
    {
        ...
        {
            finalize_8f6d6a28264adb8d(__context__,(*__aV_rename_at_1217_3));
        }
...
inline TArray<regex::ReNode *> _FuncbuiltinTickto_array_moveTick3185538323411982277_4c5483eb7641701a ( Context * __context__, TDim<regex::ReNode *,2> &  __a_rename_at_1375_13 )
{
    ...
    _FuncbuiltinTickresizeTick4811697762258667383_7fc2d92ecf01659d(__context__,das_arg<TArray<regex::ReNode *>>::pass(__arr_rename_at_1377_14),2);
