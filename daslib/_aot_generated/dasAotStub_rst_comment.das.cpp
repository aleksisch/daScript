...
inline void finalize_83696062e344b3c4 ( Context * __context__, AutoTuple<char *,char *,char *> & ____this_rename_at_1219_2 );
...
inline void _FuncbuiltinTickpushTick10769833213962245646_8de87bc637551de2 ( Context * __context__, TArray<ast::AstCommentReader *> & __Arr_rename_at_181_4, ast::AstCommentReader * __value_rename_at_181_5 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_7733b5525c63da34 ( Context * __context__, rst_comment::RstComment const  & __cl_rename_at_116_6 );
inline TArray<AutoTuple<char *,char *>> _FuncbuiltinTickto_array_moveTick3185538323411982277_c562e1bb9a69fcf2 ( Context * __context__, TDim<AutoTuple<char *,char *>,1> & __a_rename_at_1375_7 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_e7318b7a6abc1eef ( Context * __context__, TArray<uint8_t> & __a_rename_at_1215_9 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_63555a7fd208695d ( Context * __context__, TArray<AutoTuple<char *,char *,char *>> & __a_rename_at_1215_10 );
inline smart_ptr_raw<CommentReader> _FuncastTickmake_comment_readerTick2128729122050972798_df562ecd26c8e373 ( Context * __context__, char * const  __name_rename_at_714_12, rst_comment::RstComment * __someClassPtr_rename_at_714_13 );
...
inline void _FuncastTickadd_new_comment_readerTick9279614113534996372_a6d4bfc5c5585407 ( Context * __context__, char * const  __name_rename_at_900_27, rst_comment::RstComment * __someClassPtr_rename_at_900_28 );
...
inline TArray<AutoTuple<char *,char *>> _FuncbuiltinTickto_array_moveTick3185538323411982277_c562e1bb9a69fcf2 ( Context * __context__, TDim<AutoTuple<char *,char *>,1> &  __a_rename_at_1375_7 )
{
    ...
    _FuncbuiltinTickresizeTick4811697762258667383_ae4622b87d5045ec(__context__,das_arg<TArray<AutoTuple<char *,char *>>>::pass(__arr_rename_at_1377_8),1);
...
{
    {
        ...
        {
            finalize_83696062e344b3c4(__context__,das_arg<AutoTuple<char *,char *,char *>>::pass((*__aV_rename_at_1217_11)));
        }
...
inline smart_ptr_raw<CommentReader> _FuncastTickmake_comment_readerTick2128729122050972798_df562ecd26c8e373 ( Context * __context__, char * const  __name_rename_at_714_12, rst_comment::RstComment * __someClassPtr_rename_at_714_13 )
{
    _FuncbuiltinTickpushTick10769833213962245646_8de87bc637551de2(__context__,das_arg<TArray<ast::AstCommentReader *>>::pass(das_global<TArray<ast::AstCommentReader *>,0xd806bcc7af45ea49>(__context__) /*gc_root_AstCommentReader*/),das_reinterpret<ast::AstCommentReader *>::pass(__someClassPtr_rename_at_714_13));
    StructInfo const  * __classInfo_rename_at_717_14 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_7733b5525c63da34(__context__,das_arg<rst_comment::RstComment>::pass(das_deref(__context__,__someClassPtr_rename_at_714_13))));
...
inline void _FuncastTickadd_new_comment_readerTick9279614113534996372_a6d4bfc5c5585407 ( Context * __context__, char * const  __name_rename_at_900_27, rst_comment::RstComment * __someClassPtr_rename_at_900_28 )
{
    ...
    /* end finally */ });
    __ann_rename_at_901_29; das_zero(__ann_rename_at_901_29); das_move(__ann_rename_at_901_29, _FuncastTickmake_comment_readerTick2128729122050972798_df562ecd26c8e373(__context__,__name_rename_at_900_27,__someClassPtr_rename_at_900_28));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x8dd8f4465d0212fb] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_8de87bc637551de2>>();
    };
    aotLib[0x5908e19dd882e36d] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_7733b5525c63da34>>();
    };
    ...
    aotLib[0x442e98d8b2311f9b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_comment_readerTick2128729122050972798_df562ecd26c8e373>>();
    };
    ...
    aotLib[0x9b38ea595b282d54] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickadd_new_comment_readerTick9279614113534996372_a6d4bfc5c5585407>>();
    };
