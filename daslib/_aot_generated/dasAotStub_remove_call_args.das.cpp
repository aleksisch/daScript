...
namespace das {
namespace _anon_11098408474829485071 {
...
namespace remove_call_args {

struct RemoveCallArgsMacro {
    void * __rtti;
    Func DAS_COMMENT((void,ast::AstFunctionAnnotation)) __finalize;
    Func DAS_COMMENT((smart_ptr_raw<Expression>,ast::AstFunctionAnnotation,smart_ptr_raw<ExprCallFunc>,das::string)) transform;
    Func DAS_COMMENT((bool,ast::AstFunctionAnnotation,smart_ptr_raw<ExprCallFunc>,AnnotationArgumentList const ,AnnotationArgumentList const ,das::string)) verifyCall;
...
inline void _FuncbuiltinTickpushTick10769833213962245646_9f4af0aefa3ee194 ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_0, ast::AstFunctionAnnotation * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_2d00e71a7b16cb7a ( Context * __context__, remove_call_args::RemoveCallArgsMacro const  & __cl_rename_at_116_2 );
inline TArray<int32_t> & _FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_33d049c8a9f7c3f4 ( Context * __context__, TArray<int32_t> & __a_rename_at_50_3 );
inline void _FuncbuiltinTickpushTick14133213201864676143_44d4ec4f41e3c029 ( Context * __context__, TArray<int32_t> & __Arr_rename_at_165_4, int32_t __value_rename_at_165_5 );
inline void _FuncbuiltinTicksortTick5995501125257068354_145e91a5088e7b20 ( Context * __context__, TArray<int32_t> & __a_rename_at_1609_6, Block DAS_COMMENT((bool,int32_t,int32_t)) const  & __cmp_rename_at_1609_7 );
inline range _FuncbuiltinTickiter_rangeTick1065493836214144684_ae1dab2566c15fb1 ( Context * __context__, AnnotationList const  & __foo_rename_at_1283_8 );
...
inline TArray<int32_t> & _FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_33d049c8a9f7c3f4 ( Context * __context__, TArray<int32_t> &  __a_rename_at_50_3 )
{
    das_call_interop<void>::call(&builtin_verify_locks,__context__,SimNode_AotInterop<1>(__tinfo_0,cast<TArray<int32_t> &>::from(__a_rename_at_50_3)));
    return das_auto_cast_ref<TArray<int32_t> &>::cast(__a_rename_at_50_3);
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x60ae89e794f66ac6] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_9f4af0aefa3ee194>>();
    };
    aotLib[0x3c32cc7584873697] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_2d00e71a7b16cb7a>>();
    };
    aotLib[0x5a0ff71de76b635d] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTick_return_with_lockcheckTick2939372000839727345_33d049c8a9f7c3f4>>();
    };
    aotLib[0x3bbace1ed079003a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick14133213201864676143_44d4ec4f41e3c029>>();
    };
    aotLib[0x661e571cbdea4a64] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTicksortTick5995501125257068354_145e91a5088e7b20>>();
    };
    aotLib[0xbbabe1de7447b07e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickiter_rangeTick1065493836214144684_ae1dab2566c15fb1>>();
    };
    resolveTypeInfoAnnotations();
}

} // namespace _anon_11098408474829485071
AotListBase impl_aot_remove_call_args(_anon_11098408474829485071::registerAotFunctions);
} // namespace das
