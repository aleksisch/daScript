...
inline void _FuncbuiltinTickpushTick10769833213962245646_96a83d81256b8be ( Context * __context__, TArray<ast::AstVariantMacro *> & __Arr_rename_at_181_0, ast::AstVariantMacro * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_3b60384480a0b791 ( Context * __context__, json_boost::BetterJsonMacro const  & __cl_rename_at_116_2 );
inline void _FuncbuiltinTickpushTick10769833213962245646_239b5e94c722d8 ( Context * __context__, TArray<ast::AstReaderMacro *> & __Arr_rename_at_181_3, ast::AstReaderMacro * __value_rename_at_181_4 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_ae3a14315081af6d ( Context * __context__, json_boost::JsonReader const  & __cl_rename_at_116_5 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x9d6b7eb80dd9e8da] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_96a83d81256b8be>>();
    };
    aotLib[0x7e94a55e341a167d] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_3b60384480a0b791>>();
    };
    aotLib[0x46896da8dab688e7] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_239b5e94c722d8>>();
    };
    aotLib[0x79f2b71fa4f0cb1a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_ae3a14315081af6d>>();
    };
