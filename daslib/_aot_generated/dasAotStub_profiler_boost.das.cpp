...
inline void enable_profiler_95ec786b2594cfbf ( Context * __context__, Context & __ctx_rename_at_22_7 );
inline void disable_profiler_6ffedd6513c69c31 ( Context * __context__, Context & __ctx_rename_at_26_8 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0x7f0042cb905e92eb] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&enable_profiler_95ec786b2594cfbf>>();
    };
    aotLib[0xea59e278bcbb8948] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&disable_profiler_6ffedd6513c69c31>>();
    };
    // [[ init script ]]
