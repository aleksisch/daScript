...
inline void _FuncbuiltinTickpushTick10769833213962245646_14ebde65d1c13efd ( Context * __context__, TArray<ast::AstCallMacro *> & __Arr_rename_at_181_0, ast::AstCallMacro * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_df5e61a4be7a2969 ( Context * __context__, lpipe::LpipeMacro const  & __cl_rename_at_116_2 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xa6e1a84cc59bd2ff] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_14ebde65d1c13efd>>();
    };
    aotLib[0x6e0b8463fa4e5b15] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_df5e61a4be7a2969>>();
    };
