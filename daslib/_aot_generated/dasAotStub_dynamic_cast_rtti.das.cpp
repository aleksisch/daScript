...
inline void _FuncbuiltinTickpushTick10769833213962245646_33c565e821b5be5e ( Context * __context__, TArray<ast::AstVariantMacro *> & __Arr_rename_at_181_2, ast::AstVariantMacro * __value_rename_at_181_3 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_c205155cce22442b ( Context * __context__, dynamic_cast_rtti::ClassAsIs const  & __cl_rename_at_116_4 );
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_eddc694960502db7 ( Context * __context__, smart_ptr_raw<Expression> const  __src_rename_at_1777_7 );
...
inline smart_ptr_raw<Expression> _FuncbuiltinTickadd_ptr_refTick918185754185293024_eddc694960502db7 ( Context * __context__, smart_ptr_raw<Expression> const  __src_rename_at_1777_7 )
{
    smart_ptr_raw<Expression> __dst_rename_at_1779_8; das_zero(__dst_rename_at_1779_8); das_move(__dst_rename_at_1779_8, _FuncbuiltinTickclone_to_moveTick2007252383599261567_2b860da07a30a4d6(__context__,das_cast<smart_ptr_raw<Expression>>::cast(__src_rename_at_1777_7)));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xa1e73cb1d2a85e53] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_33c565e821b5be5e>>();
    };
    aotLib[0x88b49aa00ee1635b] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_c205155cce22442b>>();
    };
