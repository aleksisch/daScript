...
inline float4x4 look_at_lh_65f5a3dcbad7f7e3 ( Context * __context__, float3 __Eye_rename_at_106_27, float3 __At_rename_at_106_28, float3 __Up_rename_at_106_29 );
inline float4x4 look_at_rh_d3731bb2d8fbab6c ( Context * __context__, float3 __Eye_rename_at_121_34, float3 __At_rename_at_121_35, float3 __Up_rename_at_121_36 );
inline float4x4 perspective_lh_8b1fcfc1128e01f5 ( Context * __context__, float __fovy_rename_at_136_41, float __aspect_rename_at_136_42, float __zn_rename_at_136_43, float __zf_rename_at_136_44 );
inline float4x4 perspective_rh_176cc27cd638cbbe ( Context * __context__, float __fovy_rename_at_150_48, float __aspect_rename_at_150_49, float __zn_rename_at_150_50, float __zf_rename_at_150_51 );
inline float4x4 perspective_rh_opengl_5e142fa1e26ececa ( Context * __context__, float __fovy_rename_at_164_55, float __aspect_rename_at_164_56, float __zn_rename_at_164_57, float __zf_rename_at_164_58 );
inline float4x4 ortho_rh_38d5d1be6fa0a5c1 ( Context * __context__, float __left_rename_at_178_62, float __right_rename_at_178_63, float __bottom_rename_at_178_64, float __top_rename_at_178_65, float __zNear_rename_at_178_66, float __zFar_rename_at_178_67 );
...
inline float4x4 planar_shadow_10c5f511052fc81d ( Context * __context__, float4 __Light_rename_at_207_75, float4 __Plane_rename_at_207_76 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    ...
    aotLib[0xcf1fe9e2a4349ab0] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&look_at_lh_65f5a3dcbad7f7e3>>();
    };
    aotLib[0x9658e21092236495] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&look_at_rh_d3731bb2d8fbab6c>>();
    };
    aotLib[0x7292bd55a1da3b2] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&perspective_lh_8b1fcfc1128e01f5>>();
    };
    aotLib[0x2cc2ac7f189b7ba] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&perspective_rh_176cc27cd638cbbe>>();
    };
    aotLib[0x9d2494f6fa05053f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&perspective_rh_opengl_5e142fa1e26ececa>>();
    };
    aotLib[0x88e58050ae512e92] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&ortho_rh_38d5d1be6fa0a5c1>>();
    };
    ...
    aotLib[0xd23473d69209aba8] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_AotCMRES<&planar_shadow_10c5f511052fc81d>>();
    };
