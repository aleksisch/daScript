...
static inline float degrees_328d4d049bd30cef ( Context * __context__, float __f_rename_at_31_0 );
static inline float radians_ee8c5a366585b95f ( Context * __context__, float __f_rename_at_36_1 );
static inline uint32_t RGBA_TO_UCOLOR_8f89c82e07162cc6 ( Context * __context__, float __x_rename_at_41_2, float __y_rename_at_41_3, float __z_rename_at_41_4, float __w_rename_at_41_5 );
static inline uint32_t RGBA_TO_UCOLOR_df49aebb37a8d688 ( Context * __context__, float4 __xyzw_rename_at_46_6 );
static inline float4 UCOLOR_TO_RGBA_21168ce8b8a51982 ( Context * __context__, uint32_t __x_rename_at_50_7 );
static inline float3 UCOLOR_TO_RGB_a553283ab423e6b5 ( Context * __context__, uint32_t __x_rename_at_59_8 );
static inline float linear_to_SRGB_90213175148fa8e ( Context * __context__, float __x_rename_at_67_9 );
static inline float3 linear_to_SRGB_2e29306dc06d8b4 ( Context * __context__, float3 __c_rename_at_76_10 );
static inline float4 linear_to_SRGB_1da25f3c83567208 ( Context * __context__, float4 __c_rename_at_80_11 );
static inline bool is_intersecting_3ca7c7524f1c9dc5 ( Context * __context__, math_boost::AABR const  & __a_rename_at_84_12, math_boost::AABR const  & __b_rename_at_84_13 );
static inline bool is_intersecting_c31d318a049eb335 ( Context * __context__, math_boost::AABB const  & __a_rename_at_90_14, math_boost::AABB const  & __b_rename_at_90_15 );
static inline bool is_intersecting_7b1ab43c978ef6b ( Context * __context__, math_boost::Ray const  & __ray_rename_at_95_16, math_boost::AABB const  & __aabb_rename_at_95_17, float __Tmin_rename_at_95_18, float __Tmax_rename_at_95_19 );
static inline float4x4 look_at_lh_cbb8ffd0a0e23fe4 ( Context * __context__, float3 __Eye_rename_at_106_27, float3 __At_rename_at_106_28, float3 __Up_rename_at_106_29 );
static inline float4x4 look_at_rh_b237be682c2bdd82 ( Context * __context__, float3 __Eye_rename_at_121_34, float3 __At_rename_at_121_35, float3 __Up_rename_at_121_36 );
static inline float4x4 perspective_lh_955bc910ea34b8d8 ( Context * __context__, float __fovy_rename_at_136_41, float __aspect_rename_at_136_42, float __zn_rename_at_136_43, float __zf_rename_at_136_44 );
static inline float4x4 perspective_rh_e09d74c3c9231ca2 ( Context * __context__, float __fovy_rename_at_150_48, float __aspect_rename_at_150_49, float __zn_rename_at_150_50, float __zf_rename_at_150_51 );
static inline float4x4 perspective_rh_opengl_448c2e9e57ce734f ( Context * __context__, float __fovy_rename_at_164_55, float __aspect_rename_at_164_56, float __zn_rename_at_164_57, float __zf_rename_at_164_58 );
static inline float4x4 ortho_rh_9ba657365d994f79 ( Context * __context__, float __left_rename_at_178_62, float __right_rename_at_178_63, float __bottom_rename_at_178_64, float __top_rename_at_178_65, float __zNear_rename_at_178_66, float __zFar_rename_at_178_67 );
static inline float plane_dot_fbb442007739e1a5 ( Context * __context__, float4 __Plane_rename_at_191_69, float4 __Vec_rename_at_191_70 );
static inline float4 plane_normalize_b33d45ea1c8c4042 ( Context * __context__, float4 __Plane_rename_at_196_71 );
static inline float4 plane_from_point_normal_fedc1a1c58148189 ( Context * __context__, float3 __p_rename_at_202_73, float3 __n_rename_at_202_74 );
static inline float4x4 planar_shadow_a86997e7f64f1f6a ( Context * __context__, float4 __Light_rename_at_207_75, float4 __Plane_rename_at_207_76 );
