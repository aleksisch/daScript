...
inline void _FuncbuiltinTickpushTick10769833213962245646_1e9ae95ea6dcaa17 ( Context * __context__, TArray<ast::AstCallMacro *> & __Arr_rename_at_181_0, ast::AstCallMacro * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_6b8f3afe373e307 ( Context * __context__, templates::DecltypeMacro const  & __cl_rename_at_116_2 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_b063da9fc7ec2909 ( Context * __context__, templates::DecltypeNoRefMacro const  & __cl_rename_at_116_3 );
inline void _FuncbuiltinTickpushTick10769833213962245646_d0f9a3424c4198df ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_4, ast::AstFunctionAnnotation * __value_rename_at_181_5 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_20ae946a8d47c336 ( Context * __context__, templates::TemplateMacro const  & __cl_rename_at_116_6 );
...
inline int32_t _FuncbuiltinTickfind_index_ifTick4436313710217261332_15a912e389774213 ( Context * __context__, Sequence DAS_COMMENT((smart_ptr_raw<AnnotationDeclaration> &)) & __arr_rename_at_1727_16, Block DAS_COMMENT((bool,smart_ptr_raw<AnnotationDeclaration> const )) const  & __blk_rename_at_1727_17 );
inline int32_t _FuncbuiltinTickfind_index_ifTick4436313710217261332_9ddf8ff645e57168 ( Context * __context__, Sequence DAS_COMMENT((smart_ptr_raw<Variable> &)) & __arr_rename_at_1727_22, Block DAS_COMMENT((bool,smart_ptr_raw<Variable> const )) const  & __blk_rename_at_1727_23 );
...
inline int32_t _FuncbuiltinTickfind_index_ifTick4436313710217261332_15a912e389774213 ( Context * __context__, Sequence DAS_COMMENT((smart_ptr_raw<AnnotationDeclaration> &)) &  __arr_rename_at_1727_16, Block DAS_COMMENT((bool,smart_ptr_raw<AnnotationDeclaration> const )) const  &  __blk_rename_at_1727_17 )
{
    Sequence DAS_COMMENT((int32_t)) _temp_make_local_1728_22_0; _temp_make_local_1728_22_0;
    {
        ...
        // i: int
        das_iterator_count DAS_COMMENT((_temp_make_local_1728_22_0 = (builtin_count(0,1,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)))))) __i_iterator(0,1);
...
inline int32_t _FuncbuiltinTickfind_index_ifTick4436313710217261332_9ddf8ff645e57168 ( Context * __context__, Sequence DAS_COMMENT((smart_ptr_raw<Variable> &)) &  __arr_rename_at_1727_22, Block DAS_COMMENT((bool,smart_ptr_raw<Variable> const )) const  &  __blk_rename_at_1727_23 )
{
    Sequence DAS_COMMENT((int32_t)) _temp_make_local_1728_22_1; _temp_make_local_1728_22_1;
    {
        bool __need_loop_1728 = true;
        ...
        // i: int
        das_iterator_count DAS_COMMENT((_temp_make_local_1728_22_1 = (builtin_count(0,1,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)))))) __i_iterator(0,1);
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x836756c3e0421193] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_1e9ae95ea6dcaa17>>();
    };
    aotLib[0x870401c06b65faba] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_6b8f3afe373e307>>();
    };
    aotLib[0xdb40040cd110ffa2] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_b063da9fc7ec2909>>();
    };
    aotLib[0x24e138a33723761] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_d0f9a3424c4198df>>();
    };
    aotLib[0x4a5dd1654f4f7de2] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_20ae946a8d47c336>>();
    };
    ...
    aotLib[0x1c411be70d0b62ab] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickfind_index_ifTick4436313710217261332_15a912e389774213>>();
    };
