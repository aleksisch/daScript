...
inline void _FuncbuiltinTickpushTick10769833213962245646_8fa325b560bf80b3 ( Context * __context__, TArray<ast::AstFunctionAnnotation *> & __Arr_rename_at_181_0, ast::AstFunctionAnnotation * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_36615fbce778c435 ( Context * __context__, constant_expression::ConstExprAnnotation const  & __cl_rename_at_116_2 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_95fe402b80e47e5d ( Context * __context__, constant_expression::ConstantExpressionMacro const  & __cl_rename_at_116_3 );
...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_42c000f34e3fa57e ( Context * __context__, TArray<int32_t> & __a_rename_at_1215_9 );
inline void _FuncbuiltinTicksortTick14088969635007481283_c264b31e59010594 ( Context * __context__, TArray<int32_t> & __a_rename_at_1550_10 );
...
inline void _FuncbuiltinTickswapTick6899974565646937647_79a81e9e5e7373a6 ( Context * __context__, int32_t & __a_rename_at_1813_18, int32_t & __b_rename_at_1813_19 );
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x8607c19e9a40f9f0] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_8fa325b560bf80b3>>();
    };
    aotLib[0xc8e93c2cd6dbb89f] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_36615fbce778c435>>();
    };
    aotLib[0x35a98235019fab8c] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_95fe402b80e47e5d>>();
    };
