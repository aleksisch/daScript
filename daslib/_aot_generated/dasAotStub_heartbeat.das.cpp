...
inline void _FuncbuiltinTickpushTick10769833213962245646_adccb962a8598dfb ( Context * __context__, TArray<ast::AstPassMacro *> & __Arr_rename_at_181_0, ast::AstPassMacro * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_e6f43cf0de4dde60 ( Context * __context__, heartbeat::HeartbeatPass const  & __cl_rename_at_116_2 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_a89c6233cc620b95 ( Context * __context__, heartbeat::AddHeartbeat const  & __cl_rename_at_116_3 );
inline smart_ptr_raw<VisitorAdapter> _FuncastTickmake_visitorTick897644165917210720_fe048d15e012dc6f ( Context * __context__, heartbeat::AddHeartbeat const  & __someClass_rename_at_684_4 );
...
inline smart_ptr_raw<VisitorAdapter> _FuncastTickmake_visitorTick897644165917210720_fe048d15e012dc6f ( Context * __context__, heartbeat::AddHeartbeat const  &  __someClass_rename_at_684_4 )
{
    ...
    StructInfo const  * __classInfo_rename_at_688_6 = ((StructInfo const  *)_FuncrttiTickclass_infoTick15801393167907430156_a89c6233cc620b95(__context__,__someClass_rename_at_684_4));
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0xdab5b7926125c0a5] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_adccb962a8598dfb>>();
    };
    aotLib[0x6ba9734395773c13] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_e6f43cf0de4dde60>>();
    };
    aotLib[0x811612ce272654e] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_a89c6233cc620b95>>();
    };
    aotLib[0x17cff451f969fb27] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncastTickmake_visitorTick897644165917210720_fe048d15e012dc6f>>();
    };
