...
inline void _FuncbuiltinTickpushTick10769833213962245646_5cc349ccb156bce ( Context * __context__, TArray<ast::AstStructureAnnotation *> & __Arr_rename_at_181_0, ast::AstStructureAnnotation * __value_rename_at_181_1 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_1721e6fcfb930405 ( Context * __context__, interfaces::InterfaceMacro const  & __cl_rename_at_116_2 );
inline StructInfo const  * _FuncrttiTickclass_infoTick15801393167907430156_c626cc0f8bed6809 ( Context * __context__, interfaces::ImplementsMacro const  & __cl_rename_at_116_3 );
...
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_cff6366e7f521b26 ( Context * __context__, TArray<smart_ptr_raw<Expression>> & __a_rename_at_1215_6 );
inline void _FuncbuiltinTickfinalizeTick13836114024949725080_4949a09abe7f1e5b ( Context * __context__, TArray<smart_ptr_raw<Variable>> & __a_rename_at_1215_8 );
...
{
    {
        ...
        das_iterator<TArray<smart_ptr_raw<Expression>>> __aV_iterator(__a_rename_at_1215_6);
        smart_ptr_raw<Expression> * __aV_rename_at_1217_7;
        __need_loop_1217 = __aV_iterator.first(__context__,(__aV_rename_at_1217_7)) && __need_loop_1217;
        for ( ; __need_loop_1217 ; __need_loop_1217 = __aV_iterator.next(__context__,(__aV_rename_at_1217_7)) )
        {
            das_delete_handle<smart_ptr_raw<Expression>>::clear(__context__,(*__aV_rename_at_1217_7));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1217_7));
    };
    builtin_array_free(das_arg<TArray<smart_ptr_raw<Expression>>>::pass(__a_rename_at_1215_6),8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
{
    {
        ...
        das_iterator<TArray<smart_ptr_raw<Variable>>> __aV_iterator(__a_rename_at_1215_8);
        smart_ptr_raw<Variable> * __aV_rename_at_1217_9;
        __need_loop_1217 = __aV_iterator.first(__context__,(__aV_rename_at_1217_9)) && __need_loop_1217;
        for ( ; __need_loop_1217 ; __need_loop_1217 = __aV_iterator.next(__context__,(__aV_rename_at_1217_9)) )
        {
            das_delete_handle<smart_ptr_raw<Variable>>::clear(__context__,(*__aV_rename_at_1217_9));
        }
        __aV_iterator.close(__context__,(__aV_rename_at_1217_9));
    };
    builtin_array_free(das_arg<TArray<smart_ptr_raw<Variable>>>::pass(__a_rename_at_1215_8),8,__context__,((LineInfoArg *)(&LineInfo::g_LineInfoNULL)));
}
...
static void registerAotFunctions ( AotLibrary & aotLib ) {
    aotLib[0x9afbdc3cdddcda2a] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncbuiltinTickpushTick10769833213962245646_5cc349ccb156bce>>();
    };
    aotLib[0xdfeb33b3493d3e46] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_1721e6fcfb930405>>();
    };
    aotLib[0x9d0d7f377bfb9540] = +[](Context & ctx) -> SimNode* {
        return ctx.code->makeNode<AutoSimNode_Aot<&_FuncrttiTickclass_infoTick15801393167907430156_c626cc0f8bed6809>>();
    };
